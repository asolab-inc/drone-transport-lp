...
}`,dg=[new P(1,0,0),new P(-1,0,0),new P(0,1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1)],fg=[new P(0,-1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1),new P(0,-1,0),new P(0,-1,0)],Th=new pe,rr=new P,Al=new P;function pg(i,t,e){let n=new es,s=new kt,r=new kt,a=new me,o=new Jr,l=new $r,c={},u=e.maxTextureSize,p={[li]:Ue,[Ue]:li,[qe]:qe},h=new je({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new kt},radius:{value:4}},vertexShader:hg,fragmentShader:ug}),d=h.clone();d.defines.HORIZONTAL_PASS=1;let x=new Pe;x.setAttribute("position",new De(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let M=new te(x,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ys;let f=this.type;this.render=function(S,C,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||S.length===0)return;this.type===vc&&(Ut("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=Ys);let T=i.getRenderTarget(),D=i.getActiveCubeFace(),z=i.getActiveMipmapLevel(),V=i.state;V.setBlending(Cn),V.buffers.depth.getReversed()===!0?V.buffers.color.setClear(0,0,0,0):V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);let k=f!==this.type;k&&C.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(G=>G.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,G=S.length;N<G;N++){let Z=S[N],$=Z.shadow;if($===void 0){Ut("WebGLShadowMap:",Z,"has no shadow.");continue}if($.autoUpdate===!1&&$.needsUpdate===!1)continue;s.copy($.mapSize);let it=$.getFrameExtents();s.multiply(it),r.copy($.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/it.x),s.x=r.x*it.x,$.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/it.y),s.y=r.y*it.y,$.mapSize.y=r.y));let J=i.state.buffers.depth.getReversed();if($.camera._reversedDepth=J,$.map===null||k===!0){if($.map!==null&&($.map.depthTexture!==null&&($.map.depthTexture.dispose(),$.map.depthTexture=null),$.map.dispose()),this.type===as){if(Z.isPointLight){Ut("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}$.map=new Ye(s.x,s.y,{format:di,type:Sn,minFilter:Ne,magFilter:Ne,generateMipmaps:!1}),$.map.texture.name=Z.name+".shadowMap",$.map.depthTexture=new si(s.x,s.y,Mn),$.map.depthTexture.name=Z.name+".shadowMapDepth",$.map.depthTexture.format=En,$.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=Ie,$.map.depthTexture.magFilter=Ie}else Z.isPointLight?($.map=new io(s.x),$.map.depthTexture=new qr(s.x,yn)):($.map=new Ye(s.x,s.y),$.map.depthTexture=new si(s.x,s.y,yn)),$.map.depthTexture.name=Z.name+".shadowMap",$.map.depthTexture.format=En,this.type===Ys?($.map.depthTexture.compareFunction=J?Qa:Ka,$.map.depthTexture.minFilter=Ne,$.map.depthTexture.magFilter=Ne):($.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=Ie,$.map.depthTexture.magFilter=Ie);$.camera.updateProjectionMatrix()}$.map.isWebGLCubeRenderTarget!==!0&&($.map.width!==s.x||$.map.height!==s.y)&&$.map.setSize(s.x,s.y);let tt=$.map.isWebGLCubeRenderTarget?6:$.getViewportCount();Z.isPointLight!==!0&&$.updateMatrices(Z,v);for(let et=0;et<tt;et++){let It=$.getCamera(et);if(Z.isPointLight){let Ct=$.camera,se=$.matrix,Pt=Z.distance||Ct.far;Pt!==Ct.far&&(Ct.far=Pt,Ct.updateProjectionMatrix()),rr.setFromMatrixPosition(Z.matrixWorld),Ct.position.copy(rr),Al.copy(Ct.position),Al.add(dg[et]),Ct.up.copy(fg[et]),Ct.lookAt(Al),Ct.updateMatrixWorld(),se.makeTranslation(-rr.x,-rr.y,-rr.z),Th.multiplyMatrices(Ct.projectionMatrix,Ct.matrixWorldInverse),$._frustum.setFromProjectionMatrix(Th,Ct.coordinateSystem,Ct.reversedDepth)}if($.map.isWebGLCubeRenderTarget)i.setRenderTarget($.map,et),i.clear();else{et===0&&(i.setRenderTarget($.map),i.clear());let Ct=$.getViewport(et);a.set(r.x*Ct.x,r.y*Ct.y,r.x*Ct.z,r.y*Ct.w),V.viewport(a)}n=$.getFrustum(et),y(C,v,It,Z,this.type)}$.isPointLightShadow!==!0&&this.type===as&&w($,v),$.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(T,D,z)};function w(S,C){let v=t.update(M);h.defines.VSM_SAMPLES!==S.blurSamples&&(h.defines.VSM_SAMPLES=S.blurSamples,d.defines.VSM_SAMPLES=S.blurSamples,h.needsUpdate=!0,d.needsUpdate=!0),S.mapPass===null?S.mapPass=new Ye(s.x,s.y,{format:di,type:Sn}):(S.mapPass.width!==S.map.width||S.mapPass.height!==S.map.height)&&S.mapPass.setSize(S.map.width,S.map.height),h.uniforms.shadow_pass.value=S.map.depthTexture,h.uniforms.resolution.value.set(S.map.width,S.map.height),h.uniforms.radius.value=S.radius,i.setRenderTarget(S.mapPass),i.clear(),i.renderBufferDirect(C,null,v,h,M,null),d.uniforms.shadow_pass.value=S.mapPass.texture,d.uniforms.resolution.value.set(S.map.width,S.map.height),d.uniforms.radius.value=S.radius,i.setRenderTarget(S.map),i.clear(),i.renderBufferDirect(C,null,v,d,M,null)}function I(S,C,v,T){let D=null,z=v.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(z!==void 0)D=z;else if(D=v.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let V=D.uuid,k=C.uuid,N=c[V];N===void 0&&(N={},c[V]=N);let G=N[k];G===void 0&&(G=D.clone(),N[k]=G,C.addEventListener("dispose",b)),D=G}if(D.visible=C.visible,D.wireframe=C.wireframe,T===as?D.side=C.shadowSide!==null?C.shadowSide:C.side:D.side=C.shadowSide!==null?C.shadowSide:p[C.side],D.alphaMap=C.alphaMap,D.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,D.map=C.map,D.clipShadows=C.clipShadows,D.clippingPlanes=C.clippingPlanes,D.clipIntersection=C.clipIntersection,D.displacementMap=C.displacementMap,D.displacementScale=C.displacementScale,D.displacementBias=C.displacementBias,D.wireframeLinewidth=C.wireframeLinewidth,D.linewidth=C.linewidth,v.isPointLight===!0&&D.isMeshDistanceMaterial===!0){let V=i.properties.get(D);V.light=v}return D}function y(S,C,v,T,D){if(S.visible===!1)return;if(S.layers.test(C.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&D===as)&&(!S.frustumCulled||S.intersectsFrustum(n))){S.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,S.matrixWorld);let k=t.update(S),N=S.material;if(Array.isArray(N)){let G=k.groups;for(let Z=0,$=G.length;Z<$;Z++){let it=G[Z],J=N[it.materialIndex];if(J&&J.visible){let tt=I(S,J,T,D);S.onBeforeShadow(i,S,C,v,k,tt,it),i.renderBufferDirect(v,null,k,tt,S,it),S.onAfterShadow(i,S,C,v,k,tt,it)}}}else if(N.visible){let G=I(S,N,T,D);S.onBeforeShadow(i,S,C,v,k,G,null),i.renderBufferDirect(v,null,k,G,S,null),S.onAfterShadow(i,S,C,v,k,G,null)}}let V=S.children;for(let k=0,N=V.length;k<N;k++)y(V[k],C,v,T,D)}function b(S){S.target.removeEventListener("dispose",b);for(let v in c){let T=c[v],D=S.target.uuid;D in T&&(T[D].dispose(),delete T[D])}}}function mg(i,t){function e(){let U=!1,dt=new me,K=null,ot=new me(0,0,0,0);return{setMask:function(mt){K!==mt&&!U&&(i.colorMask(mt,mt,mt,mt),K=mt)},setLocked:function(mt){U=mt},setClear:function(mt,nt,Rt,At,ae){ae===!0&&(mt*=At,nt*=At,Rt*=At),dt.set(mt,nt,Rt,At),ot.equals(dt)===!1&&(i.clearColor(mt,nt,Rt,At),ot.copy(dt))},reset:function(){U=!1,K=null,ot.set(-1,0,0,0)}}}function n(){let U=!1,dt=!1,K=null,ot=null,mt=null;return{setReversed:function(nt){if(dt!==nt){let Rt=t.get("EXT_clip_control");nt?Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.ZERO_TO_ONE_EXT):Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.NEGATIVE_ONE_TO_ONE_EXT),dt=nt;let At=mt;mt=null,this.setClear(At)}},getReversed:function(){return dt},setTest:function(nt){nt?j(i.DEPTH_TEST):Mt(i.DEPTH_TEST)},setMask:function(nt){K!==nt&&!U&&(i.depthMask(nt),K=nt)},setFunc:function(nt){if(dt&&(nt=th[nt]),ot!==nt){switch(nt){case Lr:i.depthFunc(i.NEVER);break;case Dr:i.depthFunc(i.ALWAYS);break;case Nr:i.depthFunc(i.LESS);break;case Zi:i.depthFunc(i.LEQUAL);break;case Ur:i.depthFunc(i.EQUAL);break;case Fr:i.depthFunc(i.GEQUAL);break;case Or:i.depthFunc(i.GREATER);break;case Br:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ot=nt}},setLocked:function(nt){U=nt},setClear:function(nt){mt!==nt&&(mt=nt,dt&&(nt=1-nt),i.clearDepth(nt))},reset:function(){U=!1,K=null,ot=null,mt=null,dt=!1}}}function s(){let U=!1,dt=null,K=null,ot=null,mt=null,nt=null,Rt=null,At=null,ae=null;return{setTest:function(Kt){U||(Kt?j(i.STENCIL_TEST):Mt(i.STENCIL_TEST))},setMask:function(Kt){dt!==Kt&&!U&&(i.stencilMask(Kt),dt=Kt)},setFunc:function(Kt,Le,Ge){(K!==Kt||ot!==Le||mt!==Ge)&&(i.stencilFunc(Kt,Le,Ge),K=Kt,ot=Le,mt=Ge)},setOp:function(Kt,Le,Ge){(nt!==Kt||Rt!==Le||At!==Ge)&&(i.stencilOp(Kt,Le,Ge),nt=Kt,Rt=Le,At=Ge)},setLocked:function(Kt){U=Kt},setClear:function(Kt){ae!==Kt&&(i.clearStencil(Kt),ae=Kt)},reset:function(){U=!1,dt=null,K=null,ot=null,mt=null,nt=null,Rt=null,At=null,ae=null}}}let r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap,u={},p={},h={},d=new WeakMap,x=[],M=null,m=!1,f=null,w=null,I=null,y=null,b=null,S=null,C=null,v=new Nt(0,0,0),T=0,D=!1,z=null,V=null,k=null,N=null,G=null,Z=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),$=!1,it=0,J=i.getParameter(i.VERSION);J.indexOf("WebGL")!==-1?(it=parseFloat(/^WebGL (\d)/.exec(J)[1]),$=it>=1):J.indexOf("OpenGL ES")!==-1&&(it=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),$=it>=2);let tt=null,et={},It=i.getParameter(i.SCISSOR_BOX),Ct=i.getParameter(i.VIEWPORT),se=new me().fromArray(It),Pt=new me().fromArray(Ct);function Qt(U,dt,K,ot){let mt=new Uint8Array(4),nt=i.createTexture();i.bindTexture(U,nt),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Rt=0;Rt<K;Rt++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(dt,0,i.RGBA,1,1,ot,0,i.RGBA,i.UNSIGNED_BYTE,mt):i.texImage2D(dt+Rt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,mt);return nt}let q={};q[i.TEXTURE_2D]=Qt(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=Qt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=Qt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=Qt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),j(i.DEPTH_TEST),a.setFunc(Zi),Xt(!1),he(Wo),j(i.CULL_FACE),jt(Cn);function j(U){u[U]!==!0&&(i.enable(U),u[U]=!0)}function Mt(U){u[U]!==!1&&(i.disable(U),u[U]=!1)}function Bt(U,dt){return h[U]!==dt?(i.bindFramebuffer(U,dt),h[U]=dt,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=dt),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=dt),!0):!1}function vt(U,dt){let K=x,ot=!1;if(U){K=d.get(dt),K===void 0&&(K=[],d.set(dt,K));let mt=U.textures;if(K.length!==mt.length||K[0]!==i.COLOR_ATTACHMENT0){for(let nt=0,Rt=mt.length;nt<Rt;nt++)K[nt]=i.COLOR_ATTACHMENT0+nt;K.length=mt.length,ot=!0}}else K[0]!==i.BACK&&(K[0]=i.BACK,ot=!0);ot&&i.drawBuffers(K)}function Wt(U){return M!==U?(i.useProgram(U),M=U,!0):!1}let xe={[Ti]:i.FUNC_ADD,[Mc]:i.FUNC_SUBTRACT,[Sc]:i.FUNC_REVERSE_SUBTRACT};xe[bc]=i.MIN,xe[wc]=i.MAX;let Zt={[Tc]:i.ZERO,[Ec]:i.ONE,[Ac]:i.SRC_COLOR,[Yo]:i.SRC_ALPHA,[Dc]:i.SRC_ALPHA_SATURATE,[Pc]:i.DST_COLOR,[Rc]:i.DST_ALPHA,[Cc]:i.ONE_MINUS_SRC_COLOR,[Zo]:i.ONE_MINUS_SRC_ALPHA,[Lc]:i.ONE_MINUS_DST_COLOR,[Ic]:i.ONE_MINUS_DST_ALPHA,[Nc]:i.CONSTANT_COLOR,[Uc]:i.ONE_MINUS_CONSTANT_COLOR,[Fc]:i.CONSTANT_ALPHA,[Oc]:i.ONE_MINUS_CONSTANT_ALPHA};function jt(U,dt,K,ot,mt,nt,Rt,At,ae,Kt){if(U===Cn){m===!0&&(Mt(i.BLEND),m=!1);return}if(m===!1&&(j(i.BLEND),m=!0),U!==yc){if(U!==f||Kt!==D){if((w!==Ti||b!==Ti)&&(i.blendEquation(i.FUNC_ADD),w=Ti,b=Ti),Kt)switch(U){case os:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ls:i.blendFunc(i.ONE,i.ONE);break;case Xo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case qo:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ot("WebGLState: Invalid blending: ",U);break}else switch(U){case os:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ls:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Xo:Ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case qo:Ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ot("WebGLState: Invalid blending: ",U);break}I=null,y=null,S=null,C=null,v.set(0,0,0),T=0,f=U,D=Kt}return}mt=mt||dt,nt=nt||K,Rt=Rt||ot,(dt!==w||mt!==b)&&(i.blendEquationSeparate(xe[dt],xe[mt]),w=dt,b=mt),(K!==I||ot!==y||nt!==S||Rt!==C)&&(i.blendFuncSeparate(Zt[K],Zt[ot],Zt[nt],Zt[Rt]),I=K,y=ot,S=nt,C=Rt),(At.equals(v)===!1||ae!==T)&&(i.blendColor(At.r,At.g,At.b,ae),v.copy(At),T=ae),f=U,D=!1}function re(U,dt){U.side===qe?Mt(i.CULL_FACE):j(i.CULL_FACE);let K=U.side===Ue;dt&&(K=!K),Xt(K),U.blending===os&&U.transparent===!1?jt(Cn):jt(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);let ot=U.stencilWrite;o.setTest(ot),ot&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Ee(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?j(i.SAMPLE_ALPHA_TO_COVERAGE):Mt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Xt(U){z!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),z=U)}function he(U){U!==_c?(j(i.CULL_FACE),U!==V&&(U===Wo?i.cullFace(i.BACK):U===xc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Mt(i.CULL_FACE),V=U}function ye(U){U!==k&&($&&i.lineWidth(U),k=U)}function Ee(U,dt,K){U?(j(i.POLYGON_OFFSET_FILL),(N!==dt||G!==K)&&(N=dt,G=K,a.getReversed()&&(dt=-dt),i.polygonOffset(dt,K))):Mt(i.POLYGON_OFFSET_FILL)}function ue(U){U?j(i.SCISSOR_TEST):Mt(i.SCISSOR_TEST)}function ge(U){U===void 0&&(U=i.TEXTURE0+Z-1),tt!==U&&(i.activeTexture(U),tt=U)}function F(U,dt,K){K===void 0&&(tt===null?K=i.TEXTURE0+Z-1:K=tt);let ot=et[K];ot===void 0&&(ot={type:void 0,texture:void 0},et[K]=ot),(ot.type!==U||ot.texture!==dt)&&(tt!==K&&(i.activeTexture(K),tt=K),i.bindTexture(U,dt||q[U]),ot.type=U,ot.texture=dt)}function Ae(){let U=et[tt];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Gt(){try{i.compressedTexImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function E(){try{i.compressedTexImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function g(){try{i.texSubImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function B(){try{i.texSubImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function H(){try{i.compressedTexSubImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function Y(){try{i.compressedTexSubImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function ht(){try{i.texStorage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function ut(){try{i.texStorage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function X(){try{i.texImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function Q(){try{i.texImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function ft(U){return p[U]!==void 0?p[U]:i.getParameter(U)}function Tt(U,dt){p[U]!==dt&&(i.pixelStorei(U,dt),p[U]=dt)}function W(U){se.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),se.copy(U))}function at(U){Pt.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Pt.copy(U))}function wt(U,dt){let K=c.get(dt);K===void 0&&(K=new WeakMap,c.set(dt,K));let ot=K.get(U);ot===void 0&&(ot=i.getUniformBlockIndex(dt,U.name),K.set(U,ot))}function Dt(U,dt){let ot=c.get(dt).get(U);l.get(dt)!==ot&&(i.uniformBlockBinding(dt,ot,U.__bindingPointIndex),l.set(dt,ot))}function zt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},p={},tt=null,et={},h={},d=new WeakMap,x=[],M=null,m=!1,f=null,w=null,I=null,y=null,b=null,S=null,C=null,v=new Nt(0,0,0),T=0,D=!1,z=null,V=null,k=null,N=null,G=null,se.set(0,0,i.canvas.width,i.canvas.height),Pt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:j,disable:Mt,bindFramebuffer:Bt,drawBuffers:vt,useProgram:Wt,setBlending:jt,setMaterial:re,setFlipSided:Xt,setCullFace:he,setLineWidth:ye,setPolygonOffset:Ee,setScissorTest:ue,activeTexture:ge,bindTexture:F,unbindTexture:Ae,compressedTexImage2D:Gt,compressedTexImage3D:E,texImage2D:X,texImage3D:Q,pixelStorei:Tt,getParameter:ft,updateUBOMapping:wt,uniformBlockBinding:Dt,texStorage2D:ht,texStorage3D:ut,texSubImage2D:g,texSubImage3D:B,compressedTexSubImage2D:H,compressedTexSubImage3D:Y,scissor:W,viewport:at,reset:zt}}function gg(i,t,e,n,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new kt,u=new WeakMap,p=new Set,h,d=new WeakMap,x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(E,g){return x?new OffscreenCanvas(E,g):Is("canvas")}function m(E,g,B){let H=1,Y=Gt(E);if((Y.width>B||Y.height>B)&&(H=B/Math.max(Y.width,Y.height)),H<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){let ht=Math.floor(H*Y.width),ut=Math.floor(H*Y.height);h===void 0&&(h=M(ht,ut));let X=g?M(ht,ut):h;return X.width=ht,X.height=ut,X.getContext("2d").drawImage(E,0,0,ht,ut),Ut("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+ht+"x"+ut+")."),X}else return"data"in E&&Ut("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),E;return E}function f(E){return E.generateMipmaps}function w(E){i.generateMipmap(E)}function I(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(E,g,B,H,Y,ht=!1){if(E!==null){if(i[E]!==void 0)return i[E];Ut("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let ut;H&&(ut=t.get("EXT_texture_norm16"),ut||Ut("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let X=g;if(g===i.RED&&(B===i.FLOAT&&(X=i.R32F),B===i.HALF_FLOAT&&(X=i.R16F),B===i.UNSIGNED_BYTE&&(X=i.R8),B===i.UNSIGNED_SHORT&&ut&&(X=ut.R16_EXT),B===i.SHORT&&ut&&(X=ut.R16_SNORM_EXT)),g===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(X=i.R8UI),B===i.UNSIGNED_SHORT&&(X=i.R16UI),B===i.UNSIGNED_INT&&(X=i.R32UI),B===i.BYTE&&(X=i.R8I),B===i.SHORT&&(X=i.R16I),B===i.INT&&(X=i.R32I)),g===i.RG&&(B===i.FLOAT&&(X=i.RG32F),B===i.HALF_FLOAT&&(X=i.RG16F),B===i.UNSIGNED_BYTE&&(X=i.RG8),B===i.UNSIGNED_SHORT&&ut&&(X=ut.RG16_EXT),B===i.SHORT&&ut&&(X=ut.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(X=i.RG8UI),B===i.UNSIGNED_SHORT&&(X=i.RG16UI),B===i.UNSIGNED_INT&&(X=i.RG32UI),B===i.BYTE&&(X=i.RG8I),B===i.SHORT&&(X=i.RG16I),B===i.INT&&(X=i.RG32I)),g===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(X=i.RGB8UI),B===i.UNSIGNED_SHORT&&(X=i.RGB16UI),B===i.UNSIGNED_INT&&(X=i.RGB32UI),B===i.BYTE&&(X=i.RGB8I),B===i.SHORT&&(X=i.RGB16I),B===i.INT&&(X=i.RGB32I)),g===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),B===i.UNSIGNED_INT&&(X=i.RGBA32UI),B===i.BYTE&&(X=i.RGBA8I),B===i.SHORT&&(X=i.RGBA16I),B===i.INT&&(X=i.RGBA32I)),g===i.RGB&&(B===i.UNSIGNED_SHORT&&ut&&(X=ut.RGB16_EXT),B===i.SHORT&&ut&&(X=ut.RGB16_SNORM_EXT),B===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),B===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),g===i.RGBA){let Q=ht?Rs:$t.getTransfer(Y);B===i.FLOAT&&(X=i.RGBA32F),B===i.HALF_FLOAT&&(X=i.RGBA16F),B===i.UNSIGNED_BYTE&&(X=Q===ne?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT&&ut&&(X=ut.RGBA16_EXT),B===i.SHORT&&ut&&(X=ut.RGBA16_SNORM_EXT),B===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function b(E,g){let B;return E?g===null||g===yn||g===hs?B=i.DEPTH24_STENCIL8:g===Mn?B=i.DEPTH32F_STENCIL8:g===cs&&(B=i.DEPTH24_STENCIL8,Ut("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===yn||g===hs?B=i.DEPTH_COMPONENT24:g===Mn?B=i.DEPTH_COMPONENT32F:g===cs&&(B=i.DEPTH_COMPONENT16),B}function S(E,g){return f(E)===!0||E.isFramebufferTexture&&E.minFilter!==Ie&&E.minFilter!==Ne?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function C(E){let g=E.target;g.removeEventListener("dispose",C),T(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&p.delete(g)}function v(E){let g=E.target;g.removeEventListener("dispose",v),z(g)}function T(E){let g=n.get(E);if(g.__webglInit===void 0)return;let B=E.source,H=d.get(B);if(H){let Y=H[g.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&D(E),Object.keys(H).length===0&&d.delete(B)}n.remove(E)}function D(E){let g=n.get(E);i.deleteTexture(g.__webglTexture);let B=E.source,H=d.get(B);delete H[g.__cacheKey],a.memory.textures--}function z(E){let g=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(g.__webglFramebuffer[H]))for(let Y=0;Y<g.__webglFramebuffer[H].length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[H][Y]);else i.deleteFramebuffer(g.__webglFramebuffer[H]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[H])}else{if(Array.isArray(g.__webglFramebuffer))for(let H=0;H<g.__webglFramebuffer.length;H++)i.deleteFramebuffer(g.__webglFramebuffer[H]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let H=0;H<g.__webglColorRenderbuffer.length;H++)g.__webglColorRenderbuffer[H]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[H]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}let B=E.textures;for(let H=0,Y=B.length;H<Y;H++){let ht=n.get(B[H]);ht.__webglTexture&&(i.deleteTexture(ht.__webglTexture),a.memory.textures--),n.remove(B[H])}n.remove(E)}let V=0;function k(){V=0}function N(){return V}function G(E){V=E}function Z(){let E=V;return E>=s.maxTextures&&Ut("WebGLTextures: Trying to use "+(E+1)+" texture units while this GPU supports only "+s.maxTextures),V+=1,E}function $(E){let g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function it(E,g){let B=n.get(E);if(E.isVideoTexture&&F(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&B.__version!==E.version){let H=E.image;if(H===null)Ut("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)Ut("WebGLRenderer: Texture marked for update but image is incomplete");else{Mt(B,E,g);return}}else E.isExternalTexture&&(B.__webglTexture=E.sourceTexture?E.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+g)}function J(E,g){let B=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&B.__version!==E.version){Mt(B,E,g);return}else E.isExternalTexture&&(B.__webglTexture=E.sourceTexture?E.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+g)}function tt(E,g){let B=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&B.__version!==E.version){Mt(B,E,g);return}e.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+g)}function et(E,g){let B=n.get(E);if(E.isCubeDepthTexture!==!0&&E.version>0&&B.__version!==E.version){Bt(B,E,g);return}e.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+g)}let It={[bi]:i.REPEAT,[Tn]:i.CLAMP_TO_EDGE,[zr]:i.MIRRORED_REPEAT},Ct={[Ie]:i.NEAREST,[Vc]:i.NEAREST_MIPMAP_NEAREST,[$s]:i.NEAREST_MIPMAP_LINEAR,[Ne]:i.LINEAR,[pa]:i.LINEAR_MIPMAP_NEAREST,[hi]:i.LINEAR_MIPMAP_LINEAR},se={[Wc]:i.NEVER,[Jc]:i.ALWAYS,[Xc]:i.LESS,[Ka]:i.LEQUAL,[qc]:i.EQUAL,[Qa]:i.GEQUAL,[Yc]:i.GREATER,[Zc]:i.NOTEQUAL};function Pt(E,g){if(g.type===Mn&&t.has("OES_texture_float_linear")===!1&&(g.magFilter===Ne||g.magFilter===pa||g.magFilter===$s||g.magFilter===hi||g.minFilter===Ne||g.minFilter===pa||g.minFilter===$s||g.minFilter===hi)&&Ut("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,It[g.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,It[g.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,It[g.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,Ct[g.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,Ct[g.minFilter]),g.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,se[g.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Ie||g.minFilter!==$s&&g.minFilter!==hi||g.type===Mn&&t.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){let B=t.get("EXT_texture_filter_anisotropic");i.texParameterf(E,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Qt(E,g){let B=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",C));let H=g.source,Y=d.get(H);Y===void 0&&(Y={},d.set(H,Y));let ht=$(g);if(ht!==E.__cacheKey){Y[ht]===void 0&&(Y[ht]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,B=!0),Y[ht].usedTimes++;let ut=Y[E.__cacheKey];ut!==void 0&&(Y[E.__cacheKey].usedTimes--,ut.usedTimes===0&&D(g)),E.__cacheKey=ht,E.__webglTexture=Y[ht].texture}return B}function q(E,g,B){return Math.floor(Math.floor(E/B)/g)}function j(E,g,B,H){let ht=E.updateRanges;if(ht.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,B,H,g.data);else{ht.sort((Tt,W)=>Tt.start-W.start);let ut=0;for(let Tt=1;Tt<ht.length;Tt++){let W=ht[ut],at=ht[Tt],wt=W.start+W.count,Dt=q(at.start,g.width,4),zt=q(W.start,g.width,4);at.start<=wt+1&&Dt===zt&&q(at.start+at.count-1,g.width,4)===Dt?W.count=Math.max(W.count,at.start+at.count-W.start):(++ut,ht[ut]=at)}ht.length=ut+1;let X=e.getParameter(i.UNPACK_ROW_LENGTH),Q=e.getParameter(i.UNPACK_SKIP_PIXELS),ft=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Tt=0,W=ht.length;Tt<W;Tt++){let at=ht[Tt],wt=Math.floor(at.start/4),Dt=Math.ceil(at.count/4),zt=wt%g.width,U=Math.floor(wt/g.width),dt=Dt,K=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,zt),e.pixelStorei(i.UNPACK_SKIP_ROWS,U),e.texSubImage2D(i.TEXTURE_2D,0,zt,U,dt,K,B,H,g.data)}E.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,X),e.pixelStorei(i.UNPACK_SKIP_PIXELS,Q),e.pixelStorei(i.UNPACK_SKIP_ROWS,ft)}}function Mt(E,g,B){let H=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(H=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(H=i.TEXTURE_3D);let Y=Qt(E,g),ht=g.source;e.bindTexture(H,E.__webglTexture,i.TEXTURE0+B);let ut=n.get(ht);if(ht.version!==ut.__version||Y===!0){if(e.activeTexture(i.TEXTURE0+B),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){let K=$t.getPrimaries($t.workingColorSpace),ot=g.colorSpace===Gn?null:$t.getPrimaries(g.colorSpace),mt=g.colorSpace===Gn||K===ot?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,mt)}e.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let Q=m(g.image,!1,s.maxTextureSize);Q=Ae(g,Q);let ft=r.convert(g.format,g.colorSpace),Tt=r.convert(g.type),W=y(g.internalFormat,ft,Tt,g.normalized,g.colorSpace,g.isVideoTexture);Pt(H,g);let at,wt=g.mipmaps,Dt=g.isVideoTexture!==!0,zt=ut.__version===void 0||Y===!0,U=ht.dataReady,dt=S(g,Q);if(g.isDepthTexture)W=b(g.format===ui,g.type),zt&&(Dt?e.texStorage2D(i.TEXTURE_2D,1,W,Q.width,Q.height):e.texImage2D(i.TEXTURE_2D,0,W,Q.width,Q.height,0,ft,Tt,null));else if(g.isDataTexture)if(wt.length>0){Dt&&zt&&e.texStorage2D(i.TEXTURE_2D,dt,W,wt[0].width,wt[0].height);for(let K=0,ot=wt.length;K<ot;K++)at=wt[K],Dt?U&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,at.width,at.height,ft,Tt,at.data):e.texImage2D(i.TEXTURE_2D,K,W,at.width,at.height,0,ft,Tt,at.data);g.generateMipmaps=!1}else Dt?(zt&&e.texStorage2D(i.TEXTURE_2D,dt,W,Q.width,Q.height),U&&j(g,Q,ft,Tt)):e.texImage2D(i.TEXTURE_2D,0,W,Q.width,Q.height,0,ft,Tt,Q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Dt&&zt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,dt,W,wt[0].width,wt[0].height,Q.depth);for(let K=0,ot=wt.length;K<ot;K++)if(at=wt[K],g.format!==ln)if(ft!==null)if(Dt){if(U)if(g.layerUpdates.size>0){let mt=gl(at.width,at.height,g.format,g.type);for(let nt of g.layerUpdates){let Rt=at.data.subarray(nt*mt/at.data.BYTES_PER_ELEMENT,(nt+1)*mt/at.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,nt,at.width,at.height,1,ft,Rt)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,at.width,at.height,Q.depth,ft,at.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,K,W,at.width,at.height,Q.depth,0,at.data,0,0);else Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Dt?U&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,at.width,at.height,Q.depth,ft,Tt,at.data):e.texImage3D(i.TEXTURE_2D_ARRAY,K,W,at.width,at.height,Q.depth,0,ft,Tt,at.data);g.layerUpdates.size>0&&g.clearLayerUpdates()}else{Dt&&zt&&e.texStorage2D(i.TEXTURE_2D,dt,W,wt[0].width,wt[0].height);for(let K=0,ot=wt.length;K<ot;K++)at=wt[K],g.format!==ln?ft!==null?Dt?U&&e.compressedTexSubImage2D(i.TEXTURE_2D,K,0,0,at.width,at.height,ft,at.data):e.compressedTexImage2D(i.TEXTURE_2D,K,W,at.width,at.height,0,at.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Dt?U&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,at.width,at.height,ft,Tt,at.data):e.texImage2D(i.TEXTURE_2D,K,W,at.width,at.height,0,ft,Tt,at.data)}else if(g.isDataArrayTexture)if(Dt){if(zt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,dt,W,Q.width,Q.height,Q.depth),U)if(g.layerUpdates.size>0){let K=gl(Q.width,Q.height,g.format,g.type);for(let ot of g.layerUpdates){let mt=Q.data.subarray(ot*K/Q.data.BYTES_PER_ELEMENT,(ot+1)*K/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ot,Q.width,Q.height,1,ft,Tt,mt)}g.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ft,Tt,Q.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,W,Q.width,Q.height,Q.depth,0,ft,Tt,Q.data);else if(g.isData3DTexture)Dt?(zt&&e.texStorage3D(i.TEXTURE_3D,dt,W,Q.width,Q.height,Q.depth),U&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ft,Tt,Q.data)):e.texImage3D(i.TEXTURE_3D,0,W,Q.width,Q.height,Q.depth,0,ft,Tt,Q.data);else if(g.isFramebufferTexture){if(zt)if(Dt)e.texStorage2D(i.TEXTURE_2D,dt,W,Q.width,Q.height);else{let K=Q.width,ot=Q.height;for(let mt=0;mt<dt;mt++)e.texImage2D(i.TEXTURE_2D,mt,W,K,ot,0,ft,Tt,null),K>>=1,ot>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){let K=i.canvas;if(K.hasAttribute("layoutsubtree")||K.setAttribute("layoutsubtree","true"),Q.parentNode!==K){K.appendChild(Q),p.add(g),K.onpaint=ot=>{let mt=ot.changedElements;for(let nt of p)mt.includes(nt.image)&&(nt.needsUpdate=!0)},K.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,Q);else{let mt=i.RGBA,nt=i.RGBA,Rt=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,mt,nt,Rt,Q)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(wt.length>0){if(Dt&&zt){let K=Gt(wt[0]);e.texStorage2D(i.TEXTURE_2D,dt,W,K.width,K.height)}for(let K=0,ot=wt.length;K<ot;K++)at=wt[K],Dt?U&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,ft,Tt,at):e.texImage2D(i.TEXTURE_2D,K,W,ft,Tt,at);g.generateMipmaps=!1}else if(Dt){if(zt){let K=Gt(Q);e.texStorage2D(i.TEXTURE_2D,dt,W,K.width,K.height)}U&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ft,Tt,Q)}else e.texImage2D(i.TEXTURE_2D,0,W,ft,Tt,Q);f(g)&&w(H),ut.__version=ht.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function Bt(E,g,B){if(g.image.length!==6)return;let H=Qt(E,g),Y=g.source;e.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+B);let ht=n.get(Y);if(Y.version!==ht.__version||H===!0){e.activeTexture(i.TEXTURE0+B);let ut=$t.getPrimaries($t.workingColorSpace),X=g.colorSpace===Gn?null:$t.getPrimaries(g.colorSpace),Q=g.colorSpace===Gn||ut===X?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);let ft=g.isCompressedTexture||g.image[0].isCompressedTexture,Tt=g.image[0]&&g.image[0].isDataTexture,W=[];for(let nt=0;nt<6;nt++)!ft&&!Tt?W[nt]=m(g.image[nt],!0,s.maxCubemapSize):W[nt]=Tt?g.image[nt].image:g.image[nt],W[nt]=Ae(g,W[nt]);let at=W[0],wt=r.convert(g.format,g.colorSpace),Dt=r.convert(g.type),zt=y(g.internalFormat,wt,Dt,g.normalized,g.colorSpace),U=g.isVideoTexture!==!0,dt=ht.__version===void 0||H===!0,K=Y.dataReady,ot=S(g,at);Pt(i.TEXTURE_CUBE_MAP,g);let mt;if(ft){U&&dt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ot,zt,at.width,at.height);for(let nt=0;nt<6;nt++){mt=W[nt].mipmaps;for(let Rt=0;Rt<mt.length;Rt++){let At=mt[Rt];g.format!==ln?wt!==null?U?K&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,0,0,At.width,At.height,wt,At.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,zt,At.width,At.height,0,At.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,0,0,At.width,At.height,wt,Dt,At.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,zt,At.width,At.height,0,wt,Dt,At.data)}}}else{if(mt=g.mipmaps,U&&dt){mt.length>0&&ot++;let nt=Gt(W[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ot,zt,nt.width,nt.height)}for(let nt=0;nt<6;nt++)if(Tt){U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,W[nt].width,W[nt].height,wt,Dt,W[nt].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,zt,W[nt].width,W[nt].height,0,wt,Dt,W[nt].data);for(let Rt=0;Rt<mt.length;Rt++){let ae=mt[Rt].image[nt].image;U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,0,0,ae.width,ae.height,wt,Dt,ae.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,zt,ae.width,ae.height,0,wt,Dt,ae.data)}}else{U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,wt,Dt,W[nt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,zt,wt,Dt,W[nt]);for(let Rt=0;Rt<mt.length;Rt++){let At=mt[Rt];U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,0,0,wt,Dt,At.image[nt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,zt,wt,Dt,At.image[nt])}}}f(g)&&w(i.TEXTURE_CUBE_MAP),ht.__version=Y.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function vt(E,g,B,H,Y,ht){let ut=r.convert(B.format,B.colorSpace),X=r.convert(B.type),Q=y(B.internalFormat,ut,X,B.normalized,B.colorSpace),ft=n.get(g),Tt=n.get(B);if(Tt.__renderTarget=g,!ft.__hasExternalTextures){let W=Math.max(1,g.width>>ht),at=Math.max(1,g.height>>ht);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?e.texImage3D(Y,ht,Q,W,at,g.depth,0,ut,X,null):e.texImage2D(Y,ht,Q,W,at,0,ut,X,null)}e.bindFramebuffer(i.FRAMEBUFFER,E),ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,H,Y,Tt.__webglTexture,0,ue(g)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,H,Y,Tt.__webglTexture,ht),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Wt(E,g,B){if(i.bindRenderbuffer(i.RENDERBUFFER,E),g.depthBuffer){let H=g.depthTexture,Y=H&&H.isDepthTexture?H.type:null,ht=b(g.stencilBuffer,Y),ut=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ge(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ue(g),ht,g.width,g.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,ue(g),ht,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ht,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ut,i.RENDERBUFFER,E)}else{let H=g.textures;for(let Y=0;Y<H.length;Y++){let ht=H[Y],ut=r.convert(ht.format,ht.colorSpace),X=r.convert(ht.type),Q=y(ht.internalFormat,ut,X,ht.normalized,ht.colorSpace);ge(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ue(g),Q,g.width,g.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,ue(g),Q,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,Q,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function xe(E,g,B){let H=g.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Y=n.get(g.depthTexture);if(Y.__renderTarget=g,(!Y.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),H){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,g.depthTexture.addEventListener("dispose",C)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Pt(i.TEXTURE_CUBE_MAP,g.depthTexture);let ft=r.convert(g.depthTexture.format),Tt=r.convert(g.depthTexture.type),W;g.depthTexture.format===En?W=i.DEPTH_COMPONENT24:g.depthTexture.format===ui&&(W=i.DEPTH24_STENCIL8);for(let at=0;at<6;at++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+at,0,W,g.width,g.height,0,ft,Tt,null)}}else it(g.depthTexture,0);let ht=Y.__webglTexture,ut=ue(g),X=H?i.TEXTURE_CUBE_MAP_POSITIVE_X+B:i.TEXTURE_2D,Q=g.depthTexture.format===ui?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===En)ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,X,ht,0,ut):i.framebufferTexture2D(i.FRAMEBUFFER,Q,X,ht,0);else if(g.depthTexture.format===ui)ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,X,ht,0,ut):i.framebufferTexture2D(i.FRAMEBUFFER,Q,X,ht,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Zt(E){let g=n.get(E),B=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){let H=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),H){let Y=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,H.removeEventListener("dispose",Y)};H.addEventListener("dispose",Y),g.__depthDisposeCallback=Y}g.__boundDepthTexture=H}if(E.depthTexture&&!g.__autoAllocateDepthBuffer)if(B)for(let H=0;H<6;H++)xe(g.__webglFramebuffer[H],E,H);else{let H=E.texture.mipmaps;H&&H.length>0?xe(g.__webglFramebuffer[0],E,0):xe(g.__webglFramebuffer,E,0)}else if(B){g.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(e.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[H]),g.__webglDepthbuffer[H]===void 0)g.__webglDepthbuffer[H]=i.createRenderbuffer(),Wt(g.__webglDepthbuffer[H],E,!1);else{let Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ht=g.__webglDepthbuffer[H];i.bindRenderbuffer(i.RENDERBUFFER,ht),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,ht)}}else{let H=E.texture.mipmaps;if(H&&H.length>0?e.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Wt(g.__webglDepthbuffer,E,!1);else{let Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ht=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ht),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,ht)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function jt(E,g,B){let H=n.get(E);g!==void 0&&vt(H.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&Zt(E)}function re(E){let g=E.texture,B=n.get(E),H=n.get(g);E.addEventListener("dispose",v);let Y=E.textures,ht=E.isWebGLCubeRenderTarget===!0,ut=Y.length>1;if(ut||(H.__webglTexture===void 0&&(H.__webglTexture=i.createTexture()),H.__version=g.version,a.memory.textures++),ht){B.__webglFramebuffer=[];for(let X=0;X<6;X++)if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer[X]=[];for(let Q=0;Q<g.mipmaps.length;Q++)B.__webglFramebuffer[X][Q]=i.createFramebuffer()}else B.__webglFramebuffer[X]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer=[];for(let X=0;X<g.mipmaps.length;X++)B.__webglFramebuffer[X]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(ut)for(let X=0,Q=Y.length;X<Q;X++){let ft=n.get(Y[X]);ft.__webglTexture===void 0&&(ft.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&ge(E)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let X=0;X<Y.length;X++){let Q=Y[X];B.__webglColorRenderbuffer[X]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[X]);let ft=r.convert(Q.format,Q.colorSpace),Tt=r.convert(Q.type),W=y(Q.internalFormat,ft,Tt,Q.normalized,Q.colorSpace,E.isXRRenderTarget===!0),at=ue(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,at,W,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+X,i.RENDERBUFFER,B.__webglColorRenderbuffer[X])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),Wt(B.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ht){e.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture),Pt(i.TEXTURE_CUBE_MAP,g);for(let X=0;X<6;X++)if(g.mipmaps&&g.mipmaps.length>0)for(let Q=0;Q<g.mipmaps.length;Q++)vt(B.__webglFramebuffer[X][Q],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,Q);else vt(B.__webglFramebuffer[X],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);f(g)&&w(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ut){for(let X=0,Q=Y.length;X<Q;X++){let ft=Y[X],Tt=n.get(ft),W=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(W=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(W,Tt.__webglTexture),Pt(W,ft),vt(B.__webglFramebuffer,E,ft,i.COLOR_ATTACHMENT0+X,W,0),f(ft)&&w(W)}e.unbindTexture()}else{let X=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(X=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(X,H.__webglTexture),Pt(X,g),g.mipmaps&&g.mipmaps.length>0)for(let Q=0;Q<g.mipmaps.length;Q++)vt(B.__webglFramebuffer[Q],E,g,i.COLOR_ATTACHMENT0,X,Q);else vt(B.__webglFramebuffer,E,g,i.COLOR_ATTACHMENT0,X,0);f(g)&&w(X),e.unbindTexture()}E.depthBuffer&&Zt(E)}function Xt(E){let g=E.textures;for(let B=0,H=g.length;B<H;B++){let Y=g[B];if(f(Y)){let ht=I(E),ut=n.get(Y).__webglTexture;e.bindTexture(ht,ut),w(ht),e.unbindTexture()}}}let he=[],ye=[];function Ee(E){if(E.samples>0){if(ge(E)===!1){let g=E.textures,B=E.width,H=E.height,Y=i.COLOR_BUFFER_BIT,ht=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ut=n.get(E),X=g.length>1;if(X)for(let ft=0;ft<g.length;ft++)e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ut.__webglMultisampledFramebuffer);let Q=E.texture.mipmaps;Q&&Q.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ut.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ut.__webglFramebuffer);for(let ft=0;ft<g.length;ft++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),X){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ut.__webglColorRenderbuffer[ft]);let Tt=n.get(g[ft]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Tt,0)}i.blitFramebuffer(0,0,B,H,0,0,B,H,Y,i.NEAREST),l===!0&&(he.length=0,ye.length=0,he.push(i.COLOR_ATTACHMENT0+ft),E.depthBuffer&&E.storeMultisampledDepthBuffer===!1&&(he.push(ht),ye.push(ht),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ye)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,he))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),X)for(let ft=0;ft<g.length;ft++){e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.RENDERBUFFER,ut.__webglColorRenderbuffer[ft]);let Tt=n.get(g[ft]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.TEXTURE_2D,Tt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ut.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.storeMultisampledDepthBuffer===!1&&l){let g=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function ue(E){return Math.min(s.maxSamples,E.samples)}function ge(E){let g=n.get(E);return E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function F(E){let g=a.render.frame;u.get(E)!==g&&(u.set(E,g),E.update())}function Ae(E,g){let B=E.colorSpace,H=E.format,Y=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||B!==Cs&&B!==Gn&&($t.getTransfer(B)===ne?(H!==ln||Y!==Ze)&&Ut("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ot("WebGLTextures: Unsupported texture color space:",B)),g}function Gt(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=Z,this.resetTextureUnits=k,this.getTextureUnits=N,this.setTextureUnits=G,this.setTexture2D=it,this.setTexture2DArray=J,this.setTexture3D=tt,this.setTextureCube=et,this.rebindTextures=jt,this.setupRenderTarget=re,this.updateRenderTargetMipmap=Xt,this.updateMultisampleRenderTarget=Ee,this.setupDepthRenderbuffer=Zt,this.setupFrameBufferTexture=vt,this.useMultisampledRTT=ge,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function _g(i,t){function e(n,s=Gn){let r,a=$t.getTransfer(s);if(n===Ze)return i.UNSIGNED_BYTE;if(n===ga)return i.UNSIGNED_SHORT_4_4_4_4;if(n===_a)return i.UNSIGNED_SHORT_5_5_5_1;if(n===sl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===rl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===nl)return i.BYTE;if(n===il)return i.SHORT;if(n===cs)return i.UNSIGNED_SHORT;if(n===ma)return i.INT;if(n===yn)return i.UNSIGNED_INT;if(n===Mn)return i.FLOAT;if(n===Sn)return i.HALF_FLOAT;if(n===al)return i.ALPHA;if(n===ol)return i.RGB;if(n===ln)return i.RGBA;if(n===En)return i.DEPTH_COMPONENT;if(n===ui)return i.DEPTH_STENCIL;if(n===ll)return i.RED;if(n===xa)return i.RED_INTEGER;if(n===di)return i.RG;if(n===va)return i.RG_INTEGER;if(n===ya)return i.RGBA_INTEGER;if(n===Ks||n===Qs||n===js||n===tr)if(a===ne)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ks)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Qs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===tr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ks)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Qs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===tr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ma||n===Sa||n===ba||n===wa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Ma)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Sa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ba)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===wa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ta||n===Ea||n===Aa||n===Ca||n===Ra||n===er||n===Ia)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ta||n===Ea)return a===ne?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Aa)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ca)return r.COMPRESSED_R11_EAC;if(n===Ra)return r.COMPRESSED_SIGNED_R11_EAC;if(n===er)return r.COMPRESSED_RG11_EAC;if(n===Ia)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Pa||n===La||n===Da||n===Na||n===Ua||n===Fa||n===Oa||n===Ba||n===za||n===Va||n===ka||n===Ga||n===Ha||n===Wa)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Pa)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===La)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Da)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Na)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ua)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Fa)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Oa)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ba)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===za)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Va)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ka)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ga)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ha)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Wa)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Xa||n===qa||n===Ya)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Xa)return a===ne?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===qa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ya)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Za||n===Ja||n===nr||n===$a)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Za)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ja)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===nr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===$a)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===hs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var xg=`
void main() {
...
}`,Ul=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new Bs(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new je({vertexShader:xg,fragmentShader:vg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new te(new kn(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Fl=class extends An{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,u=null,p=null,h=null,d=null,x=null,M=typeof XRWebGLBinding<"u",m=new Ul,f={},w=e.getContextAttributes(),I=null,y=null,b=[],S=[],C=new kt,v=null,T=null,D=new ze;D.viewport=new me;let z=new ze;z.viewport=new me;let V=[D,z],k=new ca,N=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let j=b[q];return j===void 0&&(j=new ji,b[q]=j),j.getTargetRaySpace()},this.getControllerGrip=function(q){let j=b[q];return j===void 0&&(j=new ji,b[q]=j),j.getGripSpace()},this.getHand=function(q){let j=b[q];return j===void 0&&(j=new ji,b[q]=j),j.getHandSpace()};function Z(q){let j=S.indexOf(q.inputSource);if(j===-1)return;let Mt=b[j];Mt!==void 0&&(Mt.update(q.inputSource,q.frame,c||a),Mt.dispatchEvent({type:q.type,data:q.inputSource}))}function $(){s.removeEventListener("select",Z),s.removeEventListener("selectstart",Z),s.removeEventListener("selectend",Z),s.removeEventListener("squeeze",Z),s.removeEventListener("squeezestart",Z),s.removeEventListener("squeezeend",Z),s.removeEventListener("end",$),s.removeEventListener("inputsourceschange",it);for(let q=0;q<b.length;q++){let j=S[q];j!==null&&(S[q]=null,b[q].disconnect(j))}N=null,G=null,m.reset();for(let q in f)delete f[q];if(t.setRenderTarget(I),d=null,h=null,p=null,s=null,y=null,Qt.stop(),n.isPresenting=!1,t.setPixelRatio(v),t.setSize(C.width,C.height,!1),T!==null){let q=T.camera;q.fov=T.fov,q.zoom=T.zoom,q.updateProjectionMatrix(),T=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){r=q,n.isPresenting===!0&&Ut("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,n.isPresenting===!0&&Ut("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return h!==null?h:d},this.getBinding=function(){return p===null&&M&&(p=new XRWebGLBinding(s,e)),p},this.getFrame=function(){return x},this.getSession=function(){return s},this.setSession=async function(q){if(s=q,s!==null){if(I=t.getRenderTarget(),s.addEventListener("select",Z),s.addEventListener("selectstart",Z),s.addEventListener("selectend",Z),s.addEventListener("squeeze",Z),s.addEventListener("squeezestart",Z),s.addEventListener("squeezeend",Z),s.addEventListener("end",$),s.addEventListener("inputsourceschange",it),w.xrCompatible!==!0&&await e.makeXRCompatible(),v=t.getPixelRatio(),t.getSize(C),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let Mt=null,Bt=null,vt=null;w.depth&&(vt=w.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,Mt=w.stencil?ui:En,Bt=w.stencil?hs:yn);let Wt={colorFormat:e.RGBA8,depthFormat:vt,scaleFactor:r};p=this.getBinding(),h=p.createProjectionLayer(Wt),s.updateRenderState({layers:[h]}),t.setPixelRatio(1),t.setSize(h.textureWidth,h.textureHeight,!1),y=new Ye(h.textureWidth,h.textureHeight,{format:ln,type:Ze,depthTexture:new si(h.textureWidth,h.textureHeight,Bt,void 0,void 0,void 0,void 0,void 0,void 0,Mt),stencilBuffer:w.stencil,colorSpace:t.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1,storeMultisampledDepthBuffer:h.ignoreDepthValues===!1,storeMultisampledStencilBuffer:h.ignoreDepthValues===!1})}else{let Mt={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:r};d=new XRWebGLLayer(s,e,Mt),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),y=new Ye(d.framebufferWidth,d.framebufferHeight,{format:ln,type:Ze,colorSpace:t.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1,storeMultisampledDepthBuffer:d.ignoreDepthValues===!1,storeMultisampledStencilBuffer:d.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Qt.setContext(s),Qt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function it(q){for(let j=0;j<q.removed.length;j++){let Mt=q.removed[j],Bt=S.indexOf(Mt);Bt>=0&&(S[Bt]=null,b[Bt].disconnect(Mt))}for(let j=0;j<q.added.length;j++){let Mt=q.added[j],Bt=S.indexOf(Mt);if(Bt===-1){for(let Wt=0;Wt<b.length;Wt++)if(Wt>=S.length){S.push(Mt),Bt=Wt;break}else if(S[Wt]===null){S[Wt]=Mt,Bt=Wt;break}if(Bt===-1)break}let vt=b[Bt];vt&&vt.connect(Mt)}}let J=new P,tt=new P;function et(q,j,Mt){J.setFromMatrixPosition(j.matrixWorld),tt.setFromMatrixPosition(Mt.matrixWorld);let Bt=J.distanceTo(tt),vt=j.projectionMatrix.elements,Wt=Mt.projectionMatrix.elements,xe=vt[14]/(vt[10]-1),Zt=vt[14]/(vt[10]+1),jt=(vt[9]+1)/vt[5],re=(vt[9]-1)/vt[5],Xt=(vt[8]-1)/vt[0],he=(Wt[8]+1)/Wt[0],ye=xe*Xt,Ee=xe*he,ue=Bt/(-Xt+he),ge=ue*-Xt;if(j.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(ge),q.translateZ(ue),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),vt[10]===-1)q.projectionMatrix.copy(j.projectionMatrix),q.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{let F=xe+ue,Ae=Zt+ue,Gt=ye-ge,E=Ee+(Bt-ge),g=jt*Zt/Ae*F,B=re*Zt/Ae*F;q.projectionMatrix.makePerspective(Gt,E,g,B,F,Ae),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function It(q,j){j===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(j.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(s===null)return;let j=q.near,Mt=q.far;m.texture!==null&&(m.depthNear>0&&(j=m.depthNear),m.depthFar>0&&(Mt=m.depthFar)),k.near=z.near=D.near=j,k.far=z.far=D.far=Mt,(N!==k.near||G!==k.far)&&(s.updateRenderState({depthNear:k.near,depthFar:k.far}),N=k.near,G=k.far),k.layers.mask=q.layers.mask|6,D.layers.mask=k.layers.mask&-5,z.layers.mask=k.layers.mask&-3;let Bt=q.parent,vt=k.cameras;It(k,Bt);for(let Wt=0;Wt<vt.length;Wt++)It(vt[Wt],Bt);vt.length===2?et(k,D,z):k.projectionMatrix.copy(D.projectionMatrix),T===null&&q.isPerspectiveCamera&&(T={camera:q,fov:q.fov,zoom:q.zoom}),Ct(q,k,Bt)};function Ct(q,j,Mt){Mt===null?q.matrix.copy(j.matrixWorld):(q.matrix.copy(Mt.matrixWorld),q.matrix.invert(),q.matrix.multiply(j.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(j.projectionMatrix),q.projectionMatrixInverse.copy(j.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Ki*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(h===null&&d===null))return l},this.setFoveation=function(q){l=q,h!==null&&(h.fixedFoveation=q),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=q)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(k)},this.getCameraTexture=function(q){return f[q]};let se=null;function Pt(q,j){if(u=j.getViewerPose(c||a),x=j,u!==null){let Mt=u.views;d!==null&&(t.setRenderTargetFramebuffer(y,d.framebuffer),t.setRenderTarget(y));let Bt=!1;Mt.length!==k.cameras.length&&(k.cameras.length=0,Bt=!0);for(let Zt=0;Zt<Mt.length;Zt++){let jt=Mt[Zt],re=null;if(d!==null)re=d.getViewport(jt);else{let he=p.getViewSubImage(h,jt);re=he.viewport,Zt===0&&(t.setRenderTargetTextures(y,he.colorTexture,he.depthStencilTexture),t.setRenderTarget(y))}let Xt=V[Zt];Xt===void 0&&(Xt=new ze,Xt.layers.enable(Zt),Xt.viewport=new me,V[Zt]=Xt),Xt.matrix.fromArray(jt.transform.matrix),Xt.matrix.decompose(Xt.position,Xt.quaternion,Xt.scale),Xt.projectionMatrix.fromArray(jt.projectionMatrix),Xt.projectionMatrixInverse.copy(Xt.projectionMatrix).invert(),Xt.viewport.set(re.x,re.y,re.width,re.height),Zt===0&&(k.matrix.copy(Xt.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),Bt===!0&&k.cameras.push(Xt)}let vt=s.enabledFeatures;if(vt&&vt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&M){p=n.getBinding();let Zt=p.getDepthInformation(Mt[0]);Zt&&Zt.isValid&&Zt.texture&&m.init(Zt,s.renderState)}if(vt&&vt.includes("camera-access")&&M){t.state.unbindTexture(),p=n.getBinding();for(let Zt=0;Zt<Mt.length;Zt++){let jt=Mt[Zt].camera;if(jt){let re=f[jt];re||(re=new Bs,f[jt]=re);let Xt=p.getCameraImage(jt);re.sourceTexture=Xt}}}}for(let Mt=0;Mt<b.length;Mt++){let Bt=S[Mt],vt=b[Mt];Bt!==null&&vt!==void 0&&vt.update(Bt,j,c||a)}se&&se(q,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),x=null}let Qt=new Eh;Qt.setAnimationLoop(Pt),this.setAnimationLoop=function(q){se=q},this.dispose=function(){}}},yg=new pe,Lh=new Vt;Lh.set(-1,0,0,0,1,0,0,0,1);function Mg(i,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,fl(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,w,I,y){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?r(m,f):f.isMeshLambertMaterial?(r(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(r(m,f),p(m,f)):f.isMeshPhongMaterial?(r(m,f),u(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(r(m,f),h(m,f),f.isMeshPhysicalMaterial&&d(m,f,y)):f.isMeshMatcapMaterial?(r(m,f),x(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),M(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,w,I):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Ue&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Ue&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);let w=t.get(f),I=w.envMap,y=w.envMapRotation;I&&(m.envMap.value=I,m.envMapRotation.value.setFromMatrix4(yg.makeRotationFromEuler(y)).transpose(),I.isCubeTexture&&I.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Lh),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,w,I){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*w,m.scale.value=I*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function p(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function h(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function d(m,f,w){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Ue&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.retroreflectivity>0&&(m.retroreflectivity.value=f.retroreflectivity),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,f){f.matcap&&(m.matcap.value=f.matcap)}function M(m,f){let w=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Sg(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,b){let S=b.program;n.uniformBlockBinding(y,S)}function c(y,b){let S=s[y.id];S===void 0&&(m(y),S=u(y),s[y.id]=S,y.addEventListener("dispose",w));let C=b.program;n.updateUBOMapping(y,C);let v=t.render.frame;r[y.id]!==v&&(h(y),r[y.id]=v)}function u(y){let b=p();y.__bindingPointIndex=b;let S=i.createBuffer(),C=y.__size,v=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,S),i.bufferData(i.UNIFORM_BUFFER,C,v),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,S),S}function p(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return Ot("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(y){let b=s[y.id],S=y.uniforms,C=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let v=0,T=S.length;v<T;v++){let D=S[v];if(Array.isArray(D))for(let z=0,V=D.length;z<V;z++)d(D[z],v,z,C);else d(D,v,0,C)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function d(y,b,S,C){if(M(y,b,S,C)===!0){let v=y.__offset,T=y.value;if(Array.isArray(T)){let D=0;for(let z=0;z<T.length;z++){let V=T[z],k=f(V);x(V,y.__data,D),typeof V!="number"&&typeof V!="boolean"&&!V.isMatrix3&&!ArrayBuffer.isView(V)&&(D+=k.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(T,y.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,v,y.__data)}}function x(y,b,S){typeof y=="number"||typeof y=="boolean"?b[0]=y:y.isMatrix3?(b[0]=y.elements[0],b[1]=y.elements[1],b[2]=y.elements[2],b[3]=0,b[4]=y.elements[3],b[5]=y.elements[4],b[6]=y.elements[5],b[7]=0,b[8]=y.elements[6],b[9]=y.elements[7],b[10]=y.elements[8],b[11]=0):ArrayBuffer.isView(y)?b.set(new y.constructor(y.buffer,y.byteOffset,b.length)):y.toArray(b,S)}function M(y,b,S,C){let v=y.value,T=b+"_"+S;if(C[T]===void 0)return typeof v=="number"||typeof v=="boolean"?C[T]=v:ArrayBuffer.isView(v)?C[T]=v.slice():C[T]=v.clone(),!0;{let D=C[T];if(typeof v=="number"||typeof v=="boolean"){if(D!==v)return C[T]=v,!0}else{if(ArrayBuffer.isView(v))return!0;if(D.equals(v)===!1)return D.copy(v),!0}}return!1}function m(y){let b=y.uniforms,S=0,C=16;for(let T=0,D=b.length;T<D;T++){let z=Array.isArray(b[T])?b[T]:[b[T]];for(let V=0,k=z.length;V<k;V++){let N=z[V],G=Array.isArray(N.value)?N.value:[N.value];for(let Z=0,$=G.length;Z<$;Z++){let it=G[Z],J=f(it),tt=S%C,et=tt%J.boundary,It=tt+et;S+=et,It!==0&&C-It<J.storage&&(S+=C-It),N.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=S,S+=J.storage}}}let v=S%C;return v>0&&(S+=C-v),y.__size=S,y.__cache={},this}function f(y){let b={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(b.boundary=4,b.storage=4):y.isVector2?(b.boundary=8,b.storage=8):y.isVector3||y.isColor?(b.boundary=16,b.storage=12):y.isVector4?(b.boundary=16,b.storage=16):y.isMatrix3?(b.boundary=48,b.storage=48):y.isMatrix4?(b.boundary=64,b.storage=64):y.isTexture?Ut("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(b.boundary=16,b.storage=y.byteLength):Ut("WebGLRenderer: Unsupported uniform value type.",y),b}function w(y){let b=y.target;b.removeEventListener("dispose",w);let S=a.indexOf(b.__bindingPointIndex);a.splice(S,1),i.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function I(){for(let y in s)i.deleteBuffer(s[y]);a=[],s={},r={}}return{bind:l,update:c,dispose:I}}var bg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Rn=null;function wg(){return Rn===null&&(Rn=new Xr(bg,16,16,di,Sn),Rn.name="DFG_LUT",Rn.minFilter=Ne,Rn.magFilter=Ne,Rn.wrapS=Tn,Rn.wrapT=Tn,Rn.generateMipmaps=!1,Rn.needsUpdate=!0),Rn}var so=class{constructor(t={}){let{canvas:e=Kc(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:d=Ze}=t;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=a;let M=d,m=new Set([ya,va,xa]),f=new Set([Ze,yn,cs,hs,ga,_a]),w=new Uint32Array(4),I=new Int32Array(4),y=new P,b=null,S=null,C=[],v=[],T=null;this.domElement=e,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=vn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let D=this,z=!1,V=null,k=null,N=null,G=null;this._outputColorSpace=Re;let Z=0,$=0,it=null,J=-1,tt=null,et=new me,It=new me,Ct=null,se=new Nt(0),Pt=0,Qt=e.width,q=e.height,j=1,Mt=null,Bt=null,vt=new me(0,0,Qt,q),Wt=new me(0,0,Qt,q),xe=!1,Zt=new es,jt=!1,re=!1,Xt=new pe,he=new P,ye=new me,Ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ue=!1;function ge(){return it===null?j:1}let F=n;function Ae(_,A){return e.getContext(_,A)}let Gt,E,g,B,H,Y,ht,ut,X,Q,ft,Tt,W,at,wt,Dt,zt,U,dt,K,ot,mt,nt;try{let _={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:p};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"186"}`),e.addEventListener("webglcontextlost",ae,!1),e.addEventListener("webglcontextrestored",Kt,!1),e.addEventListener("webglcontextcreationerror",Le,!1),F===null){let A="webgl2";if(F=Ae(A,_),F===null)throw Ae(A)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}Rt()}catch(_){throw e.removeEventListener("webglcontextlost",ae,!1),e.removeEventListener("webglcontextrestored",Kt,!1),e.removeEventListener("webglcontextcreationerror",Le,!1),Ot("WebGLRenderer: "+_.message),_}function Rt(){Gt=new Pp(F),Gt.init(),ot=new _g(F,Gt),E=new Mp(F,Gt,t,ot),g=new mg(F,Gt),E.reversedDepthBuffer&&h&&g.buffers.depth.setReversed(!0),k=F.createFramebuffer(),N=F.createFramebuffer(),G=F.createFramebuffer(),B=new Np(F),H=new eg,Y=new gg(F,Gt,g,H,E,ot,B),ht=new Ip(D),ut=new Uu(F),mt=new vp(F,ut),X=new Lp(F,ut,B,mt),Q=new Fp(F,X,ut,mt,B),U=new Up(F,E,Y),wt=new Sp(H),ft=new tg(D,ht,Gt,E,mt,wt),Tt=new Mg(D,H),W=new ig,at=new cg(Gt),zt=new xp(D,ht,g,Q,x,l),Dt=new pg(D,Q,E),nt=new Sg(F,B,E,g),dt=new yp(F,Gt,B),K=new Dp(F,Gt,B),B.programs=ft.programs,D.capabilities=E,D.extensions=Gt,D.properties=H,D.renderLists=W,D.shadowMap=Dt,D.state=g,D.info=B}M!==Ze&&(T=new Bp(M,e.width,e.height,o,s,r));let At=new Fl(D,F);this.xr=At,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let _=Gt.get("WEBGL_lose_context");_&&_.loseContext()},this.forceContextRestore=function(){let _=Gt.get("WEBGL_lose_context");_&&_.restoreContext()},this.getPixelRatio=function(){return j},this.setPixelRatio=function(_){_!==void 0&&(j=_,this.setSize(Qt,q,!1))},this.getSize=function(_){return _.set(Qt,q)},this.setSize=function(_,A,O=!0){if(At.isPresenting){Ut("WebGLRenderer: Can't change size while VR device is presenting.");return}Qt=_,q=A,e.width=Math.floor(_*j),e.height=Math.floor(A*j),O===!0&&(e.style.width=_+"px",e.style.height=A+"px"),T!==null&&T.setSize(e.width,e.height),this.setViewport(0,0,_,A)},this.getDrawingBufferSize=function(_){return _.set(Qt*j,q*j).floor()},this.setDrawingBufferSize=function(_,A,O){Qt=_,q=A,j=O,e.width=Math.floor(_*O),e.height=Math.floor(A*O),this.setViewport(0,0,_,A)},this.setEffects=function(_){if(M===Ze){Ot("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(_){for(let A=0;A<_.length;A++)if(_[A].isOutputPass===!0){Ut("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(_||[])},this.getCurrentViewport=function(_){return _.copy(et)},this.getViewport=function(_){return _.copy(vt)},this.setViewport=function(_,A,O,L){_.isVector4?vt.set(_.x,_.y,_.z,_.w):vt.set(_,A,O,L),g.viewport(et.copy(vt).multiplyScalar(j).round())},this.getScissor=function(_){return _.copy(Wt)},this.setScissor=function(_,A,O,L){_.isVector4?Wt.set(_.x,_.y,_.z,_.w):Wt.set(_,A,O,L),g.scissor(It.copy(Wt).multiplyScalar(j).round())},this.getScissorTest=function(){return xe},this.setScissorTest=function(_){g.setScissorTest(xe=_)},this.setOpaqueSort=function(_){Mt=_},this.setTransparentSort=function(_){Bt=_},this.getClearColor=function(_){return _.copy(zt.getClearColor())},this.setClearColor=function(){zt.setClearColor(...arguments)},this.getClearAlpha=function(){return zt.getClearAlpha()},this.setClearAlpha=function(){zt.setClearAlpha(...arguments)},this.clear=function(_=!0,A=!0,O=!0){let L=0;if(_){let R=!1;if(it!==null){let lt=it.texture.format;R=m.has(lt)}if(R){let lt=it.texture.type,rt=f.has(lt),ct=zt.getClearColor(),xt=zt.getClearAlpha(),yt=ct.r,Ft=ct.g,Ht=ct.b;rt?(w[0]=yt,w[1]=Ft,w[2]=Ht,w[3]=xt,F.clearBufferuiv(F.COLOR,0,w)):(I[0]=yt,I[1]=Ft,I[2]=Ht,I[3]=xt,F.clearBufferiv(F.COLOR,0,I))}else L|=F.COLOR_BUFFER_BIT}A&&(L|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),O&&(L|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),L!==0&&F.clear(L)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(_){_.setRenderer(this),V=_},this.dispose=function(){e.removeEventListener("webglcontextlost",ae,!1),e.removeEventListener("webglcontextrestored",Kt,!1),e.removeEventListener("webglcontextcreationerror",Le,!1),zt.dispose(),W.dispose(),at.dispose(),H.dispose(),ht.dispose(),Q.dispose(),mt.dispose(),nt.dispose(),ft.dispose(),At.dispose(),At.removeEventListener("sessionstart",_s),At.removeEventListener("sessionend",Dn),nn.stop()};function ae(_){_.preventDefault(),hl("WebGLRenderer: Context Lost."),z=!0}function Kt(){hl("WebGLRenderer: Context Restored."),z=!1;let _=B.autoReset,A=Dt.enabled,O=Dt.autoUpdate,L=Dt.needsUpdate,R=Dt.type;Rt(),B.autoReset=_,Dt.enabled=A,Dt.autoUpdate=O,Dt.needsUpdate=L,Dt.type=R}function Le(_){Ot("WebGLRenderer: A WebGL context could not be created. Reason: ",_.statusMessage)}function Ge(_){let A=_.target;A.removeEventListener("dispose",Ge),fi(A)}function fi(_){Xn(_),H.remove(_)}function Xn(_){let A=H.get(_).programs;A!==void 0&&(A.forEach(function(O){ft.releaseProgram(O)}),_.isShaderMaterial&&ft.releaseShaderCache(_))}this.renderBufferDirect=function(_,A,O,L,R,lt){A===null&&(A=Ee);let rt=R.isMesh&&R.matrixWorld.determinantAffine()<0,ct=pt(_,A,O,L,R);g.setMaterial(L,rt);let xt=O.index,yt=1;if(L.wireframe===!0){if(xt=X.getWireframeAttribute(O),xt===void 0)return;yt=2}let Ft=O.drawRange,Ht=O.attributes.position,St=Ft.start*yt,qt=(Ft.start+Ft.count)*yt;lt!==null&&(St=Math.max(St,lt.start*yt),qt=Math.min(qt,(lt.start+lt.count)*yt)),xt!==null?(St=Math.max(St,0),qt=Math.min(qt,xt.count)):Ht!=null&&(St=Math.max(St,0),qt=Math.min(qt,Ht.count));let _e=qt-St;if(_e<0||_e===1/0)return;mt.setup(R,L,ct,O,xt);let oe,ce=dt;if(xt!==null&&(oe=ut.get(xt),ce=K,ce.setIndex(oe)),R.isMesh)L.wireframe===!0?(g.setLineWidth(L.wireframeLinewidth*ge()),ce.setMode(F.LINES)):ce.setMode(F.TRIANGLES);else if(R.isLine){let Fe=L.linewidth;Fe===void 0&&(Fe=1),g.setLineWidth(Fe*ge()),R.isLineSegments?ce.setMode(F.LINES):R.isLineLoop?ce.setMode(F.LINE_LOOP):ce.setMode(F.LINE_STRIP)}else R.isPoints?ce.setMode(F.POINTS):R.isSprite&&ce.setMode(F.TRIANGLES);if(R.isBatchedMesh)if(Gt.get("WEBGL_multi_draw"))ce.renderMultiDraw(R._multiDrawStarts,R._multiDrawCounts,R._multiDrawCount);else{let Fe=R._multiDrawStarts,bt=R._multiDrawCounts,He=R._multiDrawCount,ee=xt?ut.get(xt).bytesPerElement:1,sn=H.get(L).currentProgram.getUniforms();for(let bn=0;bn<He;bn++)sn.setValue(F,"_gl_DrawID",bn),ce.render(Fe[bn]/ee,bt[bn])}else if(R.isInstancedMesh)ce.renderInstances(St,_e,R.count);else if(O.isInstancedBufferGeometry){let Fe=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,bt=Math.min(O.instanceCount,Fe);ce.renderInstances(St,_e,bt)}else ce.render(St,_e)};function gs(_,A,O,L){V!==null&&_.isNodeMaterial&&V.setObject(L,_),jt===!0&&wt.setState(_,O,!1),_.transparent===!0&&_.side===qe&&_.forceSinglePass===!1?(_.side=Ue,_.needsUpdate=!0,_i(_,A,L),_.side=li,_.needsUpdate=!0,_i(_,A,L),_.side=qe):_i(_,A,L)}this.compile=function(_,A,O=null){O===null&&(O=_),V!==null&&V.renderStart(_,A,O),S=at.get(O),S.init(A),v.push(S),O.traverseVisible(function(R){R.isLight&&R.layers.test(A.layers)&&(S.pushLight(R),R.castShadow&&S.pushShadow(R))}),_!==O&&_.traverseVisible(function(R){R.isLight&&R.layers.test(A.layers)&&(S.pushLight(R),R.castShadow&&S.pushShadow(R))}),S.setupLights(),V!==null&&V.updateLights(S.state.lightsArray),re=this.localClippingEnabled,jt=wt.init(this.clippingPlanes,re),jt===!0&&wt.setGlobalState(this.clippingPlanes,A),V!==null&&Dt.render(S.state.shadowsArray,O,A);let L=new Set;return _.traverse(function(R){if(!(R.isMesh||R.isPoints||R.isLine||R.isSprite))return;let lt=R.material;if(lt)if(Array.isArray(lt))for(let rt=0;rt<lt.length;rt++){let ct=lt[rt];gs(ct,O,A,R),L.add(ct)}else gs(lt,O,A,R),L.add(lt)}),S=v.pop(),V!==null&&V.renderEnd(),L},this.compileAsync=function(_,A,O=null){let L=this.compile(_,A,O);return new Promise(R=>{function lt(){if(L.forEach(function(rt){let xt=H.get(rt).currentProgram;(xt===void 0||xt.isReady())&&L.delete(rt)}),L.size===0){R(_);return}setTimeout(lt,10)}Gt.get("KHR_parallel_shader_compile")!==null?lt():setTimeout(lt,10)})};let pi=null;function lr(_){pi&&pi(_)}function _s(){nn.stop()}function Dn(){nn.start()}let nn=new Eh;nn.setAnimationLoop(lr),typeof self<"u"&&nn.setContext(self),this.setAnimationLoop=function(_){pi=_,At.setAnimationLoop(_),_===null?nn.stop():nn.start()},At.addEventListener("sessionstart",_s),At.addEventListener("sessionend",Dn),this.render=function(_,A){if(A!==void 0&&A.isCamera!==!0){Ot("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(z===!0)return;V!==null&&V.renderStart(_,A);let O=At.enabled===!0&&At.isPresenting===!0,L=T!==null&&(it===null||O)&&T.begin(D,it);if(_.matrixWorldAutoUpdate===!0&&_.updateMatrixWorld(),A.parent===null&&A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),At.enabled===!0&&At.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(At.cameraAutoUpdate===!0&&At.updateCamera(A),A=At.getCamera()),_.isScene===!0&&_.onBeforeRender(D,_,A,it),S=at.get(_,v.length),S.init(A),S.state.textureUnits=Y.getTextureUnits(),v.push(S),Xt.multiplyMatrices(A.projectionMatrix,A.matrixWorldInverse),Zt.setFromProjectionMatrix(Xt,pn,A.reversedDepth),re=this.localClippingEnabled,jt=wt.init(this.clippingPlanes,re),b=W.get(_,C.length),b.init(),C.push(b),At.enabled===!0&&At.isPresenting===!0){let rt=D.xr.getDepthSensingMesh();rt!==null&&mi(rt,A,-1/0,D.sortObjects)}mi(_,A,0,D.sortObjects),b.finish(),V!==null&&V.updateLights(S.state.lightsArray),D.sortObjects===!0&&b.sort(Mt,Bt),ue=At.enabled===!1||At.isPresenting===!1||At.hasDepthSensing()===!1,ue&&zt.addToRenderList(b,_),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),jt===!0&&wt.beginShadows();let R=S.state.shadowsArray;if(Dt.render(R,_,A),jt===!0&&wt.endShadows(),(L&&T.hasRenderPass())===!1){let rt=b.opaque,ct=b.transmissive;if(S.setupLights(),A.isArrayCamera){let xt=A.cameras;if(ct.length>0)for(let yt=0,Ft=xt.length;yt<Ft;yt++){let Ht=xt[yt];xs(rt,ct,_,Ht)}ue&&zt.render(_);for(let yt=0,Ft=xt.length;yt<Ft;yt++){let Ht=xt[yt];gi(b,_,Ht,Ht.viewport)}}else ct.length>0&&xs(rt,ct,_,A),ue&&zt.render(_),gi(b,_,A)}it!==null&&$===0&&(Y.updateMultisampleRenderTarget(it),Y.updateRenderTargetMipmap(it)),L&&T.end(D),_.isScene===!0&&_.onAfterRender(D,_,A),mt.resetDefaultState(),J=-1,tt=null,v.pop(),v.length>0?(S=v[v.length-1],Y.setTextureUnits(S.state.textureUnits),jt===!0&&wt.setGlobalState(D.clippingPlanes,S.state.camera)):S=null,C.pop(),C.length>0?b=C[C.length-1]:b=null,V!==null&&V.renderEnd()};function mi(_,A,O,L){if(_.visible===!1)return;if(_.layers.test(A.layers)){if(_.isGroup)O=_.renderOrder;else if(_.isLOD)_.autoUpdate===!0&&_.update(A);else if(_.isLightProbeGrid)S.pushLightProbeGrid(_);else if(_.isLight)S.pushLight(_),_.castShadow&&S.pushShadow(_);else if(_.isSprite){if(!_.frustumCulled||_.intersectsFrustum(Zt)){L&&ye.setFromMatrixPosition(_.matrixWorld).applyMatrix4(Xt);let rt=Q.update(_),ct=_.material;ct.visible&&b.push(_,rt,ct,O,ye.z,null,A)}}else if((_.isMesh||_.isLine||_.isPoints)&&(!_.frustumCulled||_.intersectsFrustum(Zt))){let rt=Q.update(_),ct=_.material;if(L&&(_.boundingSphere!==void 0?(_.boundingSphere===null&&_.computeBoundingSphere(),ye.copy(_.boundingSphere.center)):(rt.boundingSphere===null&&rt.computeBoundingSphere(),ye.copy(rt.boundingSphere.center)),ye.applyMatrix4(_.matrixWorld).applyMatrix4(Xt)),Array.isArray(ct)){let xt=rt.groups;for(let yt=0,Ft=xt.length;yt<Ft;yt++){let Ht=xt[yt],St=ct[Ht.materialIndex];St&&St.visible&&b.push(_,rt,St,O,ye.z,Ht,A)}}else ct.visible&&b.push(_,rt,ct,O,ye.z,null,A)}}let lt=_.children;for(let rt=0,ct=lt.length;rt<ct;rt++)mi(lt[rt],A,O,L)}function gi(_,A,O,L){let{opaque:R,transmissive:lt,transparent:rt}=_;S.setupLightsView(O),jt===!0&&wt.setGlobalState(D.clippingPlanes,O),L&&g.viewport(et.copy(L)),R.length>0&&qn(R,A,O),lt.length>0&&qn(lt,A,O),rt.length>0&&qn(rt,A,O),g.buffers.depth.setTest(!0),g.buffers.depth.setMask(!0),g.buffers.color.setMask(!0),g.setPolygonOffset(!1)}function xs(_,A,O,L){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;if(S.state.transmissionRenderTarget[L.id]===void 0){let St=Gt.has("EXT_color_buffer_half_float")||Gt.has("EXT_color_buffer_float");S.state.transmissionRenderTarget[L.id]=new Ye(1,1,{generateMipmaps:!0,type:St?Sn:Ze,minFilter:hi,samples:Math.max(4,E.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:$t.workingColorSpace})}let lt=S.state.transmissionRenderTarget[L.id],rt=L.viewport||et;lt.setSize(rt.z*D.transmissionResolutionScale,rt.w*D.transmissionResolutionScale);let ct=D.getRenderTarget(),xt=D.getActiveCubeFace(),yt=D.getActiveMipmapLevel();D.setRenderTarget(lt),D.getClearColor(se),Pt=D.getClearAlpha(),Pt<1&&D.setClearColor(16777215,.5),D.clear(),ue&&zt.render(O);let Ft=D.toneMapping;D.toneMapping=vn;let Ht=L.viewport;if(L.viewport!==void 0&&(L.viewport=void 0),S.setupLightsView(L),jt===!0&&wt.setGlobalState(D.clippingPlanes,L),qn(_,O,L),Y.updateMultisampleRenderTarget(lt),Y.updateRenderTargetMipmap(lt),Gt.has("WEBGL_multisampled_render_to_texture")===!1){let St=!1;for(let qt=0,_e=A.length;qt<_e;qt++){let oe=A[qt],{object:ce,geometry:Fe,material:bt,group:He}=oe;if(bt.side===qe&&ce.layers.test(L.layers)){let ee=bt.side;bt.side=Ue,bt.needsUpdate=!0,Ri(ce,O,L,Fe,bt,He),bt.side=ee,bt.needsUpdate=!0,St=!0}}St===!0&&(Y.updateMultisampleRenderTarget(lt),Y.updateRenderTargetMipmap(lt))}D.setRenderTarget(ct,xt,yt),D.setClearColor(se,Pt),Ht!==void 0&&(L.viewport=Ht),D.toneMapping=Ft}function qn(_,A,O){let L=A.isScene===!0?A.overrideMaterial:null;for(let R=0,lt=_.length;R<lt;R++){let rt=_[R],{object:ct,geometry:xt,group:yt}=rt,Ft=rt.material;Ft.allowOverride===!0&&L!==null&&(Ft=L),ct.layers.test(O.layers)&&Ri(ct,A,O,xt,Ft,yt)}}function Ri(_,A,O,L,R,lt){V!==null&&R.isNodeMaterial&&V.setObject(_,R),_.onBeforeRender(D,A,O,L,R,lt),_.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,_.matrixWorld),_.normalMatrix.getNormalMatrix(_.modelViewMatrix),R.onBeforeRender(D,A,O,L,_,lt),R.transparent===!0&&R.side===qe&&R.forceSinglePass===!1?(R.side=Ue,R.needsUpdate=!0,D.renderBufferDirect(O,A,L,R,_,lt),R.side=li,R.needsUpdate=!0,D.renderBufferDirect(O,A,L,R,_,lt),R.side=qe):D.renderBufferDirect(O,A,L,R,_,lt),_.onAfterRender(D,A,O,L,R,lt)}function _i(_,A,O){A.isScene!==!0&&(A=Ee);let L=H.get(_),R=S.state.lights,lt=S.state.shadowsArray,rt=R.state.version,ct=ft.getParameters(_,R.state,lt,A,O,S.state.lightProbeGridArray),xt=ft.getProgramCacheKey(ct),yt=L.programs;L.environment=_.isMeshStandardMaterial||_.isMeshLambertMaterial||_.isMeshPhongMaterial?A.environment:null,L.fog=A.fog;let Ft=_.isMeshStandardMaterial||_.isMeshLambertMaterial&&!_.envMap||_.isMeshPhongMaterial&&!_.envMap;L.envMap=ht.get(_.envMap||L.environment,Ft),L.envMapRotation=L.environment!==null&&_.envMap===null?A.environmentRotation:_.envMapRotation,yt===void 0&&(_.addEventListener("dispose",Ge),yt=new Map,L.programs=yt);let Ht=yt.get(xt);if(Ht!==void 0){if(L.currentProgram===Ht&&L.lightsStateVersion===rt)return vs(_,ct),Ht}else ct.uniforms=ft.getUniforms(_),V!==null&&_.isNodeMaterial&&V.build(_,O,ct),_.onBeforeCompile(ct,D),Ht=ft.acquireProgram(ct,xt),yt.set(xt,Ht),L.uniforms=ct.uniforms;let St=L.uniforms;return(!_.isShaderMaterial&&!_.isRawShaderMaterial||_.clipping===!0)&&(St.clippingPlanes=wt.uniform),vs(_,ct),L.needsLights=_t(_),L.lightsStateVersion=rt,L.needsLights&&(St.ambientLightColor.value=R.state.ambient,St.lightProbe.value=R.state.probe,St.sunLights.value=R.state.sun,St.sunLightShadows.value=R.state.sunShadow,St.directionalLights.value=R.state.directional,St.directionalLightShadows.value=R.state.directionalShadow,St.spotLights.value=R.state.spot,St.spotLightShadows.value=R.state.spotShadow,St.rectAreaLights.value=R.state.rectArea,St.ltc_1.value=R.state.rectAreaLTC1,St.ltc_2.value=R.state.rectAreaLTC2,St.pointLights.value=R.state.point,St.pointLightShadows.value=R.state.pointShadow,St.hemisphereLights.value=R.state.hemi,St.sunShadowMatrix.value=R.state.sunShadowMatrix,St.sunShadowCascade.value=R.state.sunShadowCascade,St.directionalShadowMatrix.value=R.state.directionalShadowMatrix,St.spotLightMatrix.value=R.state.spotLightMatrix,St.spotLightMap.value=R.state.spotLightMap,St.pointShadowMatrix.value=R.state.pointShadowMatrix),L.lightProbeGrid=S.state.lightProbeGridArray.length>0,L.currentProgram=Ht,L.uniformsList=null,Ht}function Ii(_){if(_.uniformsList===null){let A=_.currentProgram.getUniforms();_.uniformsList=ps.seqWithValue(A.seq,_.uniforms)}return _.uniformsList}function vs(_,A){let O=H.get(_);O.outputColorSpace=A.outputColorSpace,O.batching=A.batching,O.batchingColor=A.batchingColor,O.instancing=A.instancing,O.instancingColor=A.instancingColor,O.instancingMorph=A.instancingMorph,O.skinning=A.skinning,O.morphTargets=A.morphTargets,O.morphNormals=A.morphNormals,O.morphColors=A.morphColors,O.morphTargetsCount=A.morphTargetsCount,O.numClippingPlanes=A.numClippingPlanes,O.numIntersection=A.numClipIntersection,O.vertexAlphas=A.vertexAlphas,O.vertexTangents=A.vertexTangents,O.toneMapping=A.toneMapping}function st(_,A){if(_.length===0)return null;if(_.length===1)return _[0].texture!==null?_[0]:null;y.setFromMatrixPosition(A.matrixWorld);for(let O=0,L=_.length;O<L;O++){let R=_[O];if(R.texture!==null&&R.boundingBox.containsPoint(y))return R}return null}function pt(_,A,O,L,R){A.isScene!==!0&&(A=Ee),Y.resetTextureUnits();let lt=A.fog,rt=L.isMeshStandardMaterial||L.isMeshLambertMaterial||L.isMeshPhongMaterial?A.environment:null,ct=it===null?D.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:$t.workingColorSpace,xt=L.isMeshStandardMaterial||L.isMeshLambertMaterial&&!L.envMap||L.isMeshPhongMaterial&&!L.envMap,yt=ht.get(L.envMap||rt,xt),Ft=L.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,Ht=!!O.attributes.tangent&&(!!L.normalMap||L.anisotropy>0),St=!!O.morphAttributes.position,qt=!!O.morphAttributes.normal,_e=!!O.morphAttributes.color,oe=vn;L.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(oe=D.toneMapping);let ce=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,Fe=ce!==void 0?ce.length:0,bt=H.get(L),He=S.state.lights;if(jt===!0&&(re===!0||_!==tt)){let de=_===tt&&L.id===J;wt.setState(L,_,de)}let ee=!1;L.version===bt.__version?(bt.needsLights&&bt.lightsStateVersion!==He.state.version||bt.outputColorSpace!==ct||R.isBatchedMesh&&bt.batching===!1||!R.isBatchedMesh&&bt.batching===!0||R.isBatchedMesh&&bt.batchingColor===!0&&R._colorsTexture===null||R.isBatchedMesh&&bt.batchingColor===!1&&R._colorsTexture!==null||R.isInstancedMesh&&bt.instancing===!1||!R.isInstancedMesh&&bt.instancing===!0||R.isSkinnedMesh&&bt.skinning===!1||!R.isSkinnedMesh&&bt.skinning===!0||R.isInstancedMesh&&bt.instancingColor===!0&&R.instanceColor===null||R.isInstancedMesh&&bt.instancingColor===!1&&R.instanceColor!==null||R.isInstancedMesh&&bt.instancingMorph===!0&&R.morphTexture===null||R.isInstancedMesh&&bt.instancingMorph===!1&&R.morphTexture!==null||bt.envMap!==yt||L.fog===!0&&bt.fog!==lt||bt.numClippingPlanes!==void 0&&(bt.numClippingPlanes!==wt.numPlanes||bt.numIntersection!==wt.numIntersection)||bt.vertexAlphas!==Ft||bt.vertexTangents!==Ht||bt.morphTargets!==St||bt.morphNormals!==qt||bt.morphColors!==_e||bt.toneMapping!==oe||bt.morphTargetsCount!==Fe||!!bt.lightProbeGrid!=S.state.lightProbeGridArray.length>0)&&(ee=!0):(ee=!0,bt.__version=L.version);let sn=bt.currentProgram;ee===!0&&(sn=_i(L,A,R),V&&L.isNodeMaterial&&V.onUpdateProgram(L,sn,bt));let bn=!1,Yn=!1,Pi=!1,le=sn.getUniforms(),ve=bt.uniforms;if(g.useProgram(sn.program)&&(bn=!0,Yn=!0,Pi=!0),L.id!==J&&(J=L.id,Yn=!0),bt.needsLights){let de=st(S.state.lightProbeGridArray,R);bt.lightProbeGrid!==de&&(bt.lightProbeGrid=de,Yn=!0)}if(bn||tt!==_){g.buffers.depth.getReversed()&&_.reversedDepth!==!0&&(_._reversedDepth=!0,_.updateProjectionMatrix()),le.setValue(F,"projectionMatrix",_.projectionMatrix),le.setValue(F,"viewMatrix",_.matrixWorldInverse);let Jn=le.map.cameraPosition;Jn!==void 0&&Jn.setValue(F,he.setFromMatrixPosition(_.matrixWorld)),E.logarithmicDepthBuffer&&le.setValue(F,"logDepthBufFC",2/(Math.log(_.far+1)/Math.LN2)),(L.isMeshPhongMaterial||L.isMeshToonMaterial||L.isMeshLambertMaterial||L.isMeshBasicMaterial||L.isMeshStandardMaterial||L.isShaderMaterial)&&le.setValue(F,"isOrthographic",_.isOrthographicCamera===!0),tt!==_&&(tt=_,Yn=!0,Pi=!0)}if(bt.needsLights&&(He.state.sunShadowMap.length>0&&le.setValue(F,"sunShadowMap",He.state.sunShadowMap,Y),He.state.directionalShadowMap.length>0&&le.setValue(F,"directionalShadowMap",He.state.directionalShadowMap,Y),He.state.spotShadowMap.length>0&&le.setValue(F,"spotShadowMap",He.state.spotShadowMap,Y),He.state.pointShadowMap.length>0&&le.setValue(F,"pointShadowMap",He.state.pointShadowMap,Y)),R.isSkinnedMesh){le.setOptional(F,R,"bindMatrix"),le.setOptional(F,R,"bindMatrixInverse");let de=R.skeleton;de&&(de.boneTexture===null&&de.computeBoneTexture(),le.setValue(F,"boneTexture",de.boneTexture,Y))}R.isBatchedMesh&&(le.setOptional(F,R,"batchingTexture"),le.setValue(F,"batchingTexture",R._matricesTexture,Y),le.setOptional(F,R,"batchingIdTexture"),le.setValue(F,"batchingIdTexture",R._indirectTexture,Y),le.setOptional(F,R,"batchingColorTexture"),R._colorsTexture!==null&&le.setValue(F,"batchingColorTexture",R._colorsTexture,Y));let Zn=O.morphAttributes;if((Zn.position!==void 0||Zn.normal!==void 0||Zn.color!==void 0)&&U.update(R,O,sn),(Yn||bt.receiveShadow!==R.receiveShadow)&&(bt.receiveShadow=R.receiveShadow,le.setValue(F,"receiveShadow",R.receiveShadow)),(L.isMeshStandardMaterial||L.isMeshLambertMaterial||L.isMeshPhongMaterial)&&L.envMap===null&&A.environment!==null&&(ve.envMapIntensity.value=A.environmentIntensity),ve.dfgLUT!==void 0&&(ve.dfgLUT.value=wg()),Yn){if(le.setValue(F,"toneMappingExposure",D.toneMappingExposure),bt.needsLights&&Et(ve,Pi),lt&&L.fog===!0&&Tt.refreshFogUniforms(ve,lt),Tt.refreshMaterialUniforms(ve,L,j,q,S.state.transmissionRenderTarget[_.id]),bt.needsLights&&bt.lightProbeGrid){let de=bt.lightProbeGrid;ve.probesSH.value=de.texture,ve.probesMin.value.copy(de.boundingBox.min),ve.probesMax.value.copy(de.boundingBox.max),ve.probesResolution.value.copy(de.resolution)}ps.upload(F,Ii(bt),ve,Y)}if(L.isShaderMaterial&&L.uniformsNeedUpdate===!0&&(ps.upload(F,Ii(bt),ve,Y),L.uniformsNeedUpdate=!1),L.isSpriteMaterial&&le.setValue(F,"center",R.center),le.setValue(F,"modelViewMatrix",R.modelViewMatrix),le.setValue(F,"normalMatrix",R.normalMatrix),le.setValue(F,"modelMatrix",R.matrixWorld),L.uniformsGroups!==void 0){let de=L.uniformsGroups;for(let Jn=0,Li=de.length;Jn<Li;Jn++){let zl=de[Jn];nt.update(zl,sn),nt.bind(zl,sn)}}return sn}function Et(_,A){_.ambientLightColor.needsUpdate=A,_.lightProbe.needsUpdate=A,_.sunLights.needsUpdate=A,_.sunLightShadows.needsUpdate=A,_.directionalLights.needsUpdate=A,_.directionalLightShadows.needsUpdate=A,_.pointLights.needsUpdate=A,_.pointLightShadows.needsUpdate=A,_.spotLights.needsUpdate=A,_.spotLightShadows.needsUpdate=A,_.rectAreaLights.needsUpdate=A,_.hemisphereLights.needsUpdate=A}function _t(_){return _.isMeshLambertMaterial||_.isMeshToonMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isShadowMaterial||_.isShaderMaterial&&_.lights===!0}this.getActiveCubeFace=function(){return Z},this.getActiveMipmapLevel=function(){return $},this.getRenderTarget=function(){return it},this.setRenderTargetTextures=function(_,A,O){let L=H.get(_);L.__autoAllocateDepthBuffer=_.resolveDepthBuffer===!1,L.__autoAllocateDepthBuffer===!1&&(L.__useRenderToTexture=!1),H.get(_.texture).__webglTexture=A,H.get(_.depthTexture).__webglTexture=L.__autoAllocateDepthBuffer?void 0:O,L.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(_,A){let O=H.get(_);O.__webglFramebuffer=A,O.__useDefaultFramebuffer=A===void 0},this.setRenderTarget=function(_,A=0,O=0){it=_,Z=A,$=O;let L=null,R=!1,lt=!1;if(_){let ct=H.get(_);if(ct.__useDefaultFramebuffer!==void 0){g.bindFramebuffer(F.FRAMEBUFFER,ct.__webglFramebuffer),et.copy(_.viewport),It.copy(_.scissor),Ct=_.scissorTest,g.viewport(et),g.scissor(It),g.setScissorTest(Ct),J=-1;return}else if(ct.__webglFramebuffer===void 0)Y.setupRenderTarget(_);else if(ct.__hasExternalTextures)Y.rebindTextures(_,H.get(_.texture).__webglTexture,H.get(_.depthTexture).__webglTexture);else if(_.depthBuffer){let Ft=_.depthTexture;if(ct.__boundDepthTexture!==Ft){if(Ft!==null&&H.has(Ft)&&(_.width!==Ft.image.width||_.height!==Ft.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Y.setupDepthRenderbuffer(_)}}let xt=_.texture;(xt.isData3DTexture||xt.isDataArrayTexture||xt.isCompressedArrayTexture)&&(lt=!0);let yt=H.get(_).__webglFramebuffer;_.isWebGLCubeRenderTarget?(Array.isArray(yt[A])?L=yt[A][O]:L=yt[A],R=!0):_.samples>0&&Y.useMultisampledRTT(_)===!1?L=H.get(_).__webglMultisampledFramebuffer:Array.isArray(yt)?L=yt[O]:L=yt,et.copy(_.viewport),It.copy(_.scissor),Ct=_.scissorTest}else et.copy(vt).multiplyScalar(j).floor(),It.copy(Wt).multiplyScalar(j).floor(),Ct=xe;if(O!==0&&(L=k),g.bindFramebuffer(F.FRAMEBUFFER,L)&&g.drawBuffers(_,L),g.viewport(et),g.scissor(It),g.setScissorTest(Ct),R){let ct=H.get(_.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+A,ct.__webglTexture,O)}else if(lt){let ct=A;for(let xt=0;xt<_.textures.length;xt++){let yt=H.get(_.textures[xt]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+xt,yt.__webglTexture,O,ct)}}else if(_!==null&&O!==0){let ct=H.get(_.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,ct.__webglTexture,O)}J=-1};function Lt(_){let A=H.get(_);return(A.__readFormat!==_.format||A.__readType!==_.type)&&(A.__readFormat=_.format,A.__readType=_.type,A.__formatReadable=E.textureFormatReadable(_.format),A.__typeReadable=E.textureTypeReadable(_.type)),A}this.readRenderTargetPixels=function(_,A,O,L,R,lt,rt,ct=0){if(!(_&&_.isWebGLRenderTarget)){Ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let xt=H.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&rt!==void 0&&(xt=xt[rt]),xt){g.bindFramebuffer(F.FRAMEBUFFER,xt);try{let yt=_.textures[ct],Ft=yt.format,Ht=yt.type;_.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+ct);let St=Lt(yt);if(St.__formatReadable===!1){Ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(St.__typeReadable===!1){Ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}A>=0&&A<=_.width-L&&O>=0&&O<=_.height-R&&F.readPixels(A,O,L,R,ot.convert(Ft),ot.convert(Ht),lt)}finally{let yt=it!==null?H.get(it).__webglFramebuffer:null;g.bindFramebuffer(F.FRAMEBUFFER,yt)}}},this.readRenderTargetPixelsAsync=async function(_,A,O,L,R,lt,rt,ct=0){if(!(_&&_.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let xt=H.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&rt!==void 0&&(xt=xt[rt]),xt)if(A>=0&&A<=_.width-L&&O>=0&&O<=_.height-R){g.bindFramebuffer(F.FRAMEBUFFER,xt);let yt=_.textures[ct],Ft=yt.format,Ht=yt.type;_.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+ct);let St=Lt(yt);if(St.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(St.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let qt=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,qt),F.bufferData(F.PIXEL_PACK_BUFFER,lt.byteLength,F.STREAM_READ),F.readPixels(A,O,L,R,ot.convert(Ft),ot.convert(Ht),0),F.bindBuffer(F.PIXEL_PACK_BUFFER,null);let _e=it!==null?H.get(it).__webglFramebuffer:null;g.bindFramebuffer(F.FRAMEBUFFER,_e);let oe=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await jc(F,oe,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,qt),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,lt),F.bindBuffer(F.PIXEL_PACK_BUFFER,null),F.deleteBuffer(qt),F.deleteSync(oe),lt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(_,A=null,O=0){let L=Math.pow(2,-O),R=Math.floor(_.image.width*L),lt=Math.floor(_.image.height*L),rt=A!==null?A.x:0,ct=A!==null?A.y:0;Y.setTexture2D(_,0),F.copyTexSubImage2D(F.TEXTURE_2D,O,0,0,rt,ct,R,lt),g.unbindTexture()},this.copyTextureToTexture=function(_,A,O=null,L=null,R=0,lt=0){let rt,ct,xt,yt,Ft,Ht,St,qt,_e,oe=_.isCompressedTexture?_.mipmaps[lt]:_.image;if(O!==null)rt=O.max.x-O.min.x,ct=O.max.y-O.min.y,xt=O.isBox3?O.max.z-O.min.z:1,yt=O.min.x,Ft=O.min.y,Ht=O.isBox3?O.min.z:0;else{let ve=Math.pow(2,-R);rt=Math.floor(oe.width*ve),ct=Math.floor(oe.height*ve),_.isDataArrayTexture?xt=oe.depth:_.isData3DTexture?xt=Math.floor(oe.depth*ve):xt=1,yt=0,Ft=0,Ht=0}L!==null?(St=L.x,qt=L.y,_e=L.z):(St=0,qt=0,_e=0);let ce=ot.convert(A.format),Fe=ot.convert(A.type),bt;A.isData3DTexture?(Y.setTexture3D(A,0),bt=F.TEXTURE_3D):A.isDataArrayTexture||A.isCompressedArrayTexture?(Y.setTexture2DArray(A,0),bt=F.TEXTURE_2D_ARRAY):(Y.setTexture2D(A,0),bt=F.TEXTURE_2D),g.activeTexture(F.TEXTURE0),g.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,A.flipY),g.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),g.pixelStorei(F.UNPACK_ALIGNMENT,A.unpackAlignment);let He=g.getParameter(F.UNPACK_ROW_LENGTH),ee=g.getParameter(F.UNPACK_IMAGE_HEIGHT),sn=g.getParameter(F.UNPACK_SKIP_PIXELS),bn=g.getParameter(F.UNPACK_SKIP_ROWS),Yn=g.getParameter(F.UNPACK_SKIP_IMAGES);g.pixelStorei(F.UNPACK_ROW_LENGTH,oe.width),g.pixelStorei(F.UNPACK_IMAGE_HEIGHT,oe.height),g.pixelStorei(F.UNPACK_SKIP_PIXELS,yt),g.pixelStorei(F.UNPACK_SKIP_ROWS,Ft),g.pixelStorei(F.UNPACK_SKIP_IMAGES,Ht);let Pi=_.isDataArrayTexture||_.isData3DTexture,le=A.isDataArrayTexture||A.isData3DTexture;if(_.isDepthTexture){let ve=H.get(_),Zn=H.get(A),de=H.get(ve.__renderTarget),Jn=H.get(Zn.__renderTarget);g.bindFramebuffer(F.READ_FRAMEBUFFER,de.__webglFramebuffer),g.bindFramebuffer(F.DRAW_FRAMEBUFFER,Jn.__webglFramebuffer);for(let Li=0;Li<xt;Li++)Pi&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,H.get(_).__webglTexture,R,Ht+Li),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,H.get(A).__webglTexture,lt,_e+Li)),F.blitFramebuffer(yt,Ft,rt,ct,St,qt,rt,ct,F.DEPTH_BUFFER_BIT,F.NEAREST);g.bindFramebuffer(F.READ_FRAMEBUFFER,null),g.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(R!==0||_.isRenderTargetTexture||H.has(_)){let ve=H.get(_),Zn=H.get(A);g.bindFramebuffer(F.READ_FRAMEBUFFER,N),g.bindFramebuffer(F.DRAW_FRAMEBUFFER,G);for(let de=0;de<xt;de++)Pi?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,ve.__webglTexture,R,Ht+de):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,ve.__webglTexture,R),le?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Zn.__webglTexture,lt,_e+de):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Zn.__webglTexture,lt),R!==0?F.blitFramebuffer(yt,Ft,rt,ct,St,qt,rt,ct,F.COLOR_BUFFER_BIT,F.NEAREST):le?F.copyTexSubImage3D(bt,lt,St,qt,_e+de,yt,Ft,rt,ct):F.copyTexSubImage2D(bt,lt,St,qt,yt,Ft,rt,ct);g.bindFramebuffer(F.READ_FRAMEBUFFER,null),g.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else le?_.isDataTexture||_.isData3DTexture?F.texSubImage3D(bt,lt,St,qt,_e,rt,ct,xt,ce,Fe,oe.data):A.isCompressedArrayTexture?F.compressedTexSubImage3D(bt,lt,St,qt,_e,rt,ct,xt,ce,oe.data):F.texSubImage3D(bt,lt,St,qt,_e,rt,ct,xt,ce,Fe,oe):_.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,lt,St,qt,rt,ct,ce,Fe,oe.data):_.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,lt,St,qt,oe.width,oe.height,ce,oe.data):F.texSubImage2D(F.TEXTURE_2D,lt,St,qt,rt,ct,ce,Fe,oe);g.pixelStorei(F.UNPACK_ROW_LENGTH,He),g.pixelStorei(F.UNPACK_IMAGE_HEIGHT,ee),g.pixelStorei(F.UNPACK_SKIP_PIXELS,sn),g.pixelStorei(F.UNPACK_SKIP_ROWS,bn),g.pixelStorei(F.UNPACK_SKIP_IMAGES,Yn),lt===0&&A.generateMipmaps&&F.generateMipmap(bt),g.unbindTexture()},this.initRenderTarget=function(_){H.get(_).__webglFramebuffer===void 0&&Y.setupRenderTarget(_)},this.initTexture=function(_){_.isCubeTexture?Y.setTextureCube(_,0):_.isData3DTexture?Y.setTexture3D(_,0):_.isDataArrayTexture||_.isCompressedArrayTexture?Y.setTexture2DArray(_,0):Y.setTexture2D(_,0),g.unbindTexture()},this.resetState=function(){Z=0,$=0,it=null,g.reset(),mt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return pn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=$t._getDrawingBufferColorSpace(t),e.unpackColorSpace=$t._getUnpackColorSpace()}};var Hn=ja.clamp,cn=ja.smoothstep;function Wn(i,t){let e=Math.imul(i|0,374761393)^Math.imul(t|0,668265263);return e=Math.imul(e^e>>>13,1274126177),((e^e>>>16)>>>0)/4294967296}function co(i,t){let e=Math.floor(i),n=Math.floor(t),s=i-e,r=t-n,a=s*s*(3-2*s),o=r*r*(3-2*r),l=Wn(e,n),c=Wn(e+1,n),u=Wn(e,n+1),p=Wn(e+1,n+1),h=l+(c-l)*a;return h+(u+(p-u)*a-h)*o}function Ol(i){return .55*Math.sin(i*.83+1.7)+.28*Math.sin(i*1.91+.4)+.17*Math.sin(i*3.67+2.9)}var Se={x:-128,z:176},be={x:176,z:-142},Je=(()=>{let i=be.x-Se.x,t=be.z-Se.z,e=Math.hypot(i,t);return{x:i/e,z:t/e,len:e}})();function Bl(i,t){let e=.0019230769230769232,n=1,s=1,r=0,a=0;for(let d=0;d<5;d++)r+=n*co(i*e*s+13.7,t*e*s+5.3),a+=n,n*=.5,s*=2.03;let o=r/a;n=1,s=1;let l=0,c=0;for(let d=0;d<5;d++){let x=co(i*e*s*.78+61.1,t*e*s*.78+23.9);l+=n*(1-Math.abs(x*2-1)),c+=n,n*=.5,s*=2.11}let u=Math.pow(l/c,2.15),p=(o*.42+u*.9)*340-52,h=Math.abs(i*Je.x+t*Je.z);return p+=132*Math.exp(-Math.pow(h/104,2)),p-=110*Math.exp(-Math.pow(Math.hypot(i-Se.x,t-Se.z)/172,2)),p+=62*Math.exp(-Math.pow(Math.hypot(i-be.x,t-be.z)/150,2)),p}var oo=Bl(Se.x,Se.z),lo=Bl(be.x,be.z);function Tg(i,t){return Math.max(1-cn(Math.hypot(i-Se.x,t-Se.z),15,52),1-cn(Math.hypot(i-be.x,t-be.z),13,46))}function or(i,t){let e=1-cn(Math.hypot(i-Se.x,t-Se.z),16,56),n=1-cn(Math.hypot(i-be.x,t-be.z),14,50);return Bl(i,t)*(1-e-n)+oo*e+lo*n}function Eg(){let t=document.createElement("canvas");t.width=t.height=256;let e=t.getContext("2d"),n=256/2,s=e.createRadialGradient(n,n,256*.05,n,n,n);s.addColorStop(0,"rgba(214,228,246,.55)"),s.addColorStop(.32,"rgba(190,210,235,.14)"),s.addColorStop(.8,"rgba(200,220,245,.30)"),s.addColorStop(.96,"rgba(214,232,255,.10)"),s.addColorStop(1,"rgba(214,232,255,0)"),e.fillStyle=s,e.beginPath(),e.arc(n,n,n,0,Math.PI*2),e.fill(),e.lineCap="round";for(let a=0;a<26;a++){let o=a/26*Math.PI*2+Wn(a,3)*.3,l=.16+Wn(a,9)*.5;e.strokeStyle=`rgba(228,240,255,${(.03+Wn(a,17)*.07).toFixed(3)})`,e.lineWidth=1+Wn(a,23)*6,e.beginPath(),e.arc(n,n,n*(.24+Wn(a,31)*.72),o,o+l),e.stroke()}let r=new ii(t);return r.colorSpace=Re,r}function Ag(){let t=document.createElement("canvas");t.width=t.height=128;let e=t.getContext("2d"),n=e.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,"rgba(255,255,255,1)"),n.addColorStop(.2,"rgba(255,255,255,.5)"),n.addColorStop(.5,"rgba(255,255,255,.1)"),n.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=n,e.fillRect(0,0,128,128);let s=new ii(t);return s.colorSpace=Re,s}function Cg(){let i=document.createElement("canvas");i.width=i.height=256;let t=i.getContext("2d");t.fillStyle="#c9a468",t.fillRect(0,0,256,256);for(let n=0;n<256;n+=3)t.fillStyle=n%6===0?"rgba(255,255,255,.10)":"rgba(90,60,25,.10)",t.fillRect(0,n,256,1.5);for(let n=0;n<256;n+=3)t.fillStyle=n%6===0?"rgba(255,255,255,.07)":"rgba(90,60,25,.08)",t.fillRect(n,0,1.5,256);for(let n=0;n<220;n++){let s=6+Math.random()*26,r=120+(Math.random()*60|0),a=88+(Math.random()*40|0);t.fillStyle="rgba("+r+","+a+",40,"+(.02+Math.random()*.05).toFixed(3)+")",t.beginPath(),t.arc(Math.random()*256,Math.random()*256,s,0,Math.PI*2),t.fill()}t.strokeStyle="rgba(70,48,20,.3)",t.lineWidth=2,t.setLineDash([5,4]);for(let n of[40,216])t.beginPath(),t.moveTo(n,0),t.lineTo(n,256),t.stroke();let e=new ii(i);return e.wrapS=e.wrapT=bi,e.repeat.set(2.4,1.6),e.colorSpace=Re,e.anisotropy=4,e}function Rg(){let e=document.createElement("canvas");e.width=64,e.height=8;let n=e.getContext("2d"),s=n.createLinearGradient(0,0,0,8);s.addColorStop(0,"rgba(255,255,255,0)"),s.addColorStop(.5,"rgba(255,255,255,1)"),s.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=s,n.fillRect(4,0,34,8);let r=new ii(e);return r.wrapS=bi,r.colorSpace=Re,r}var Dh=document.querySelector('[data-section="01-hero"]');Dh&&Ig(Dh);function Ig(i){let t=i.querySelector("[data-hero-stage]"),e=i.querySelector("[data-hero-canvas]"),n=i.querySelector("[data-hero-hud]"),s=i.querySelector("[data-hero-inset]");if(!t||!e)return;let r=!!(window.ASO&&window.ASO.isShot),a=!!(window.ASO&&window.ASO.reducedMotion),o=r||a,l=()=>{t.classList.add("is-photo"),e.remove(),s&&(s.hidden=!0),n&&(n.hidden=!0)},c;try{c=new so({canvas:e,antialias:!r&&(window.devicePixelRatio||1)<1.6,alpha:!1,powerPreference:"high-performance",preserveDrawingBuffer:r})}catch{c=null}if(!c||!c.getContext()){l();return}let u=window.matchMedia("(max-width: 767px)").matches,p=(navigator.hardwareConcurrency||4)<=4,h=r?1:u?1.5:1.75,d=r?184:p||u?144:232,x=4600,M=x/2;c.setPixelRatio(Math.min(window.devicePixelRatio||1,h)),c.toneMapping=Zs,c.toneMappingExposure=1.3;let m=6195632,f=new Ns;f.fog=new Ds(m,480,1960);let w=new ze(42,16/9,1,6400),I=new P(-.54,.3,-.79).normalize(),y=new is(4200,44,30);{let st=y.attributes.position,pt=new Float32Array(st.count*3),Et=new Nt(331034),_t=new Nt(1525114),Lt=new Nt(m),_=new Nt(15513734),A=new Nt(1454414),O=new Nt,L=new P;for(let R=0;R<st.count;R++){L.set(st.getX(R),st.getY(R),st.getZ(R)).normalize();let lt=L.y;O.copy(Lt).lerp(_t,cn(lt,0,.3)),O.lerp(Et,cn(lt,.24,.82)),lt<.03&&O.lerp(A,cn(-lt,-.03,.18));let rt=Math.pow(Math.max(L.dot(I),0),3.4)*.62*(1-cn(lt,.08,.5));O.lerp(_,Hn(rt,0,.72)),pt[R*3]=O.r,pt[R*3+1]=O.g,pt[R*3+2]=O.b}y.setAttribute("color",new De(pt,3))}let b=new te(y,new on({vertexColors:!0,side:Ue,fog:!1,depthWrite:!1}));b.renderOrder=-10,f.add(b);let S=new rs(16769984,3);S.position.copy(I).multiplyScalar(1600),f.add(S);let C=new rs(9091327,.5);C.position.set(.6,.3,.74).multiplyScalar(900),f.add(C),f.add(new Xs(13099775,2901289,1.75));let v=new kn(x,x,d,d);v.rotateX(-Math.PI/2);{let st=v.attributes.position;for(let rt=0;rt<st.count;rt++){let ct=st.getX(rt)/M,xt=st.getZ(rt)/M,yt=Math.sign(ct)*Math.pow(Math.abs(ct),1.7)*M,Ft=Math.sign(xt)*Math.pow(Math.abs(xt),1.7)*M;st.setXYZ(rt,yt,or(yt,Ft),Ft)}st.needsUpdate=!0,v.computeVertexNormals();let pt=v.attributes.normal,Et=new Float32Array(st.count*3),_t=new Nt(2179103),Lt=new Nt(3496238),_=new Nt(6062150),A=new Nt(8285006),O=new Nt(9472636),L=new Nt(10787700),R=new Nt,lt=new Nt;for(let rt=0;rt<st.count;rt++){let ct=st.getX(rt),xt=st.getY(rt),yt=st.getZ(rt),Ft=Hn(1-pt.getY(rt),0,1),Ht=Hn((xt+60)/400,0,1),St=co(ct*.0055+3.1,yt*.0055+7.7),qt=co(ct*.019+21.5,yt*.019+9.2);R.copy(_t).lerp(Lt,Hn(St*1.35,0,1)),R.lerp(_,cn(qt,.56,.92)*.5),R.lerp(A,cn(Ft,.3,.58)*.8),R.lerp(O,cn(Ft,.52,.78)),R.lerp(L,cn(Ht,.72,.99)*.5);let _e=Tg(ct,yt);_e>.002&&R.lerp(lt.copy(A).lerp(L,.5),_e*.85);let oe=.88+qt*.24;Et[rt*3]=R.r*oe,Et[rt*3+1]=R.g*oe,Et[rt*3+2]=R.b*oe}v.setAttribute("color",new De(Et,3))}let T=new Gs({vertexColors:!0,fog:!0});T.onBeforeCompile=st=>{st.vertexShader=`varying vec3 vWP;
...
`+st.fragmentShader.replace("#include <color_fragment>",`#include <color_fragment>
      ...
      diffuseColor.rgb += cline * 0.075 * vec3(0.42, 0.66, 1.0);`)},T.customProgramCacheKey=()=>"aso-hero-terrain",f.add(new te(v,T));let D=(Se.x+be.x)*.5,z=(Se.z+be.z)*.5,V=or(D,z),k={x:-Je.z,z:Je.x},N=[new P(Se.x,oo+21,Se.z),new P(Se.x+Je.x*88+k.x*8,oo+74,Se.z+Je.z*88+k.z*8),new P(D-Je.x*14,V+46,z-Je.z*14),new P(be.x-Je.x*84+k.x*6,lo+78,be.z-Je.z*84+k.z*6),new P(be.x,lo+20,be.z),new P(be.x-Je.x*62-k.x*168,lo+124,be.z-Je.z*62-k.z*168),new P(D-k.x*258,V+104,z-k.z*258),new P(Se.x+Je.x*62-k.x*176,oo+138,Se.z+Je.z*62-k.z*176)],G=new zs(N,!0,"centripetal",.5);G.arcLengthDivisions=700;let Z=G.getLength(),$=st=>{let pt=0,Et=1/0,_t=new P;for(let Lt=0;Lt<=600;Lt++){let _=Lt/600;G.getPointAt(_,_t);let A=_t.distanceToSquared(st);A<Et&&(Et=A,pt=_)}return pt},it=$(N[0]),J=$(N[4]),tt=st=>(st%1+1.5)%1-.5,et=(st,pt,Et)=>Math.exp(-Math.pow(tt(st-pt)/Et,2)),It=st=>3.4+16.4*(1-Math.max(et(st,it,.05),et(st,J,.05)));{let Et=[],_t=[],Lt=[],_=[];for(let L=0;L<=200;L++){let R=G.getPointAt(L/200*J);Et.push(new P(R.x,or(R.x,R.z)+3.4,R.z))}let A=0;for(let L=0;L<=200;L++){let R=Et[L],lt=Et[Math.max(0,L-1)],rt=Et[Math.min(200,L+1)],ct=rt.x-lt.x,xt=rt.z-lt.z,yt=Math.hypot(ct,xt)||1;L>0&&(A+=Math.hypot(R.x-Et[L-1].x,R.z-Et[L-1].z));let Ft=-xt/yt,Ht=ct/yt,St=A/13;if(_t.push(R.x+Ft*2.3,R.y,R.z+Ht*2.3,R.x-Ft*2.3,R.y,R.z-Ht*2.3),Lt.push(St,1,St,0),L<200){let qt=L*2;_.push(qt,qt+1,qt+2,qt+1,qt+3,qt+2)}}let O=new Pe;O.setAttribute("position",new De(new Float32Array(_t),3)),O.setAttribute("uv",new De(new Float32Array(Lt),2)),O.setIndex(_),f.add(new te(O,new on({map:Rg(),color:12377343,transparent:!0,opacity:.4,depthWrite:!1,side:qe,fog:!0,polygonOffset:!0,polygonOffsetFactor:-6,polygonOffsetUnits:-6})))}let Ct=[];function se(st,pt,Et){let _t=new mn;_t.position.set(st,or(st,pt)+1.8,pt);let Lt=(_,A,O)=>{let L={color:Et,transparent:!0,opacity:A,side:qe,depthWrite:!1,fog:!0};O&&(L.blending=O);let R=new te(_,new on(L));return R.rotation.x=-Math.PI/2,_t.add(R),R};Lt(new wi(10.6,12.1,72),.85),Lt(new ns(10.3,48),.12),Lt(new wi(3,3.9,40),.5);for(let _=0;_<2;_++){let A=Lt(new wi(11.5,12.7,64),.5,ls);A.position.y=.7,Ct.push({m:A,off:_*.5})}f.add(_t)}se(Se.x,Se.z,9425151),se(be.x,be.z,8176895);let Pt=new mn;f.add(Pt);let Qt=new xn({color:4936799,metalness:.4,roughness:.48}),q=new xn({color:2567479,metalness:.5,roughness:.45}),j=new xn({color:9081759,metalness:.35,roughness:.55}),Mt=new te(new gn(1.06,.5,1.52),Qt);Mt.position.y=.04,Pt.add(Mt);let Bt=new te(new gn(.84,.26,1.04),q);Bt.position.y=.36,Pt.add(Bt);let vt=new te(new gn(.64,.3,.44),q);vt.position.set(0,-.05,.84),Pt.add(vt);let Wt=new te(new _n(.17,.2,.26,16),q);Wt.position.y=-.3,Pt.add(Wt);let xe=[],Zt=Eg(),jt=Ag(),re=new ns(.78,34);re.rotateX(-Math.PI/2);let Xt=new _n(.078,.062,1.3,10);Xt.rotateZ(Math.PI/2),Xt.translate(.66,0,0);let he=new _n(.07,.07,.1,10);for(let st=0;st<4;st++){let pt=Math.PI/4+st*Math.PI/2,Et=Math.cos(pt)*1.28,_t=Math.sin(pt)*1.28,Lt=new te(Xt,Qt);Lt.rotation.y=-pt,Lt.position.y=.02,Pt.add(Lt);let _=new te(new _n(.15,.13,.52,14),q);_.position.set(Et,.12,_t),Pt.add(_);let A=new te(new _n(.035,.035,.34,8),j);A.position.set(Et,.44,_t),Pt.add(A);for(let O=0;O<2;O++){let L=new te(re,new on({map:Zt,color:13952245,transparent:!0,opacity:O?.3:.36,depthWrite:!1,side:qe,fog:!0}));L.position.set(Et,O?.62:-.1,_t),Pt.add(L),xe.push({m:L,sp:(O?-1:1)*(33+st*2.7)});let R=new te(he,q);R.position.copy(L.position),Pt.add(R)}}for(let st of[-1,1]){let pt=new te(new gn(.1,.09,1.44),j);pt.position.set(st*.53,-.78,.02),Pt.add(pt);for(let Et of[-.46,.46]){let _t=new te(new _n(.045,.045,.64,8),j);_t.position.set(st*.47,-.47,Et),_t.rotation.z=st*.12,Pt.add(_t)}}let ye=new kn(1,1);function Ee(st,pt,Et,_t,Lt){let _=new mn,A=new te(new is(.07,10,8),new on({color:_t,fog:!0}));_.add(A);let O=new te(ye,new on({map:jt,color:_t,transparent:!0,opacity:.9,blending:ls,depthWrite:!1,fog:!1}));return O.scale.setScalar(Lt),_.add(O),_.position.set(st,pt,Et),Pt.add(_),{halo:O,bulb:A}}let ue=Ee(-1.14,.12,1.1,16726832,1.6),ge=Ee(1.14,.12,1.1,4054148,1.6),F=Ee(0,-.24,-.86,16777215,2.2),Ae=u?5.4:6.4,Gt=13,E=Ae/(Gt-1),g=1/120,B=[],H=[];for(let st=0;st<Gt;st++)B.push(new P(0,-st*E,0)),H.push(new P(0,-st*E,0));let Y=new _n(.045,.045,1,6,1);Y.translate(0,.5,0);let ht=new xn({color:9095128,roughness:.75,metalness:.05}),ut=[];for(let st=0;st<Gt-1;st++){let pt=new te(Y,ht);f.add(pt),ut.push(pt)}let X=1.02,Q=new Vs([[.1,-1],[.42,-.97],[.66,-.86],[.8,-.62],[.86,-.28],[.87,.06],[.84,.34],[.74,.56],[.56,.72],[.34,.82],[.17,.9],[0,.94]].map(([st,pt])=>new P(st*X*1.35,pt*X*1.5,0)),28);{let st=Q.attributes.position;for(let pt=0;pt<st.count;pt++){let Et=st.getX(pt),_t=st.getY(pt),Lt=st.getZ(pt);if(Math.hypot(Et,Lt)>.02){let A=Math.atan2(Lt,Et),O=1+.045*Math.sin(A*4+_t*1.6)+.022*Math.sin(A*9-_t*2.4)+.014*Math.sin(A*15+_t*3.1);st.setX(pt,Et*O),st.setZ(pt,Lt*O)}}Q.computeVertexNormals(),Q.translate(0,-.86*X*1.5,0)}let ft=Cg(),Tt=new te(Q,new xn({map:ft,color:14989425,roughness:.95,metalness:0}));f.add(Tt);{let st=new xn({color:13620957,roughness:.8,metalness:.02,side:qe}),pt=.1*X*1.5,Et=pt+.92;for(let Lt=0;Lt<4;Lt++){let _=Lt/4*Math.PI*2+Math.PI/4,A=Math.cos(_)*.62*X*1.35,O=Math.sin(_)*.62*X*1.35,L=new P(A,pt-.34,O),R=new P(0,Et,0),lt=L.distanceTo(R),rt=new te(new kn(.1,lt),st);rt.position.copy(L).lerp(R,.5),rt.lookAt(rt.position.clone().add(new P(0,0,1)));let ct=R.clone().sub(L).normalize();rt.quaternion.setFromUnitVectors(new P(0,1,0),ct),rt.rotateY(_),Tt.add(rt)}let _t=new te(new ks(.15,.045,8,18),new xn({color:10135220,roughness:.5,metalness:.7}));_t.position.y=Et,_t.rotation.x=Math.PI/2,Tt.add(_t)}let W={dist:0,t:0,spd:4,alt:0,windSpd:0,pos:new P,vel:new P,prevVel:new P,acc:new P,q:new Qe,e:new an(0,0,0,"YXZ"),hook:new P,wind:new P},at=new P,wt=new P,Dt=new P,zt=new Qe,U=new P(0,1,0),dt=new P,K=new P,ot={x:0,y:0,tx:0,ty:0},mt=0;function nt(st){W.t+=st;let pt=It(W.dist/Z%1);W.spd+=(pt-W.spd)*Math.min(1,st*1.5),W.dist+=W.spd*st;let Et=W.dist/Z%1;G.getPointAt(Et,W.pos),G.getTangentAt(Et,at),W.vel.copy(at).multiplyScalar(W.spd),wt.copy(W.vel).sub(W.prevVel).divideScalar(Math.max(st,1e-4)),W.acc.lerp(wt,Math.min(1,st*5)),W.prevVel.copy(W.vel);let _t=Ol(W.t*.42)*.5+.5,Lt=Math.max(0,Ol(W.t*.17+9.3));W.windSpd=1.9+_t*2.3+Lt*3.2;let _=.6+Ol(W.t*.08)*.4;W.wind.set(Math.cos(_),0,Math.sin(_)).multiplyScalar(W.windSpd);let A=Math.atan2(W.vel.x,W.vel.z),O=wt.set(Math.sin(A),0,Math.cos(A)),L=Dt.set(O.z,0,-O.x),R=W.acc.dot(O),lt=W.acc.dot(L),rt=Hn(R*.06,-.3,.34)+Hn(W.spd*.0075,0,.13)+Math.sin(W.t*.9)*.012,ct=Hn(-lt*.08,-.5,.5)+Math.sin(W.t*.63+1.1)*.022+W.wind.dot(L)*.0045;W.e.set(rt,A,ct),W.q.setFromEuler(W.e),Pt.quaternion.slerp(W.q,Math.min(1,st*4.5)),Pt.position.copy(W.pos),Pt.position.y+=Math.sin(W.t*1.35)*.09,W.hook.set(0,-.36,0).applyQuaternion(Pt.quaternion).add(Pt.position),W.alt=Math.max(0,Pt.position.y-or(Pt.position.x,Pt.position.z))}function Rt(st){let pt=st*st;for(let Et=1;Et<Gt;Et++){let _t=B[Et],Lt=H[Et],_=(_t.x-Lt.x)*.9982,A=(_t.y-Lt.y)*.9982,O=(_t.z-Lt.z)*.9982;Lt.copy(_t);let L=Et===Gt-1?.42:.12;_t.x+=_+W.wind.x*L*pt,_t.y+=A-9.81*pt,_t.z+=O+W.wind.z*L*pt}B[0].copy(W.hook),H[0].copy(W.hook);for(let Et=0;Et<7;Et++){for(let _t=0;_t<Gt-1;_t++){let Lt=B[_t],_=B[_t+1];at.subVectors(_,Lt);let A=at.length()||1e-5,O=(A-E)/A,L=_t===0?0:_t===Gt-2?.68:.5,R=_t===0?1:_t===Gt-2?.32:.5;Lt.addScaledVector(at,O*L),_.addScaledVector(at,-O*R)}B[0].copy(W.hook)}}function At(){for(let pt=0;pt<Gt-1;pt++){let Et=B[pt];at.subVectors(B[pt+1],Et);let _t=at.length()||1e-5,Lt=ut[pt];Lt.position.copy(Et),Lt.quaternion.setFromUnitVectors(U,wt.copy(at).divideScalar(_t)),Lt.scale.set(1,_t,1)}let st=B[Gt-1];at.subVectors(st,B[Gt-2]),wt.copy(at).normalize().negate(),Tt.quaternion.setFromUnitVectors(U,wt),Tt.rotateY(Math.sin(W.t*.31)*.45+W.t*.055),Tt.position.copy(st)}function ae(st){nt(st),mt=Math.min(mt+st,g*8);let pt=0;for(;mt>=g&&pt++<8;)Rt(g),mt-=g;At();for(let Lt of xe)Lt.m.rotation.y+=Lt.sp*st;let Et=W.t%1.15<.08;F.halo.material.opacity=Et?1:0,F.bulb.visible=Et;let _t=.6+.4*Math.sin(W.t*2.1);ue.halo.material.opacity=_t,ge.halo.material.opacity=_t;for(let Lt of Ct){let _=(W.t*.4+Lt.off)%1;Lt.m.scale.setScalar(.4+_*1.5),Lt.m.material.opacity=.55*(1-_)*(1-_)}}function Kt(st,pt){let Et=w.aspect,_t=Et>=1.05,Lt=_t?25:34,_=Math.atan2(W.vel.x,W.vel.z)+Math.PI+Math.sin(W.t*.085)*.42-.2,A=(_t?4.2:5.4)+Math.sin(W.t*.061+2.2)*2.1;K.set(W.pos.x+Math.sin(_)*Lt+ot.x*2.6,W.pos.y+A+ot.y*1.6,W.pos.z+Math.cos(_)*Lt),pt?w.position.copy(K):w.position.lerp(K,1-Math.exp(-st*1.35)),w.lookAt(W.pos),w.updateMatrixWorld();let O=Math.tan(w.fov*Math.PI/360)*w.position.distanceTo(W.pos),L=_t?.32:.06,R=_t?.4:.78;wt.setFromMatrixColumn(w.matrixWorld,0),Dt.setFromMatrixColumn(w.matrixWorld,1),at.copy(W.pos).addScaledVector(wt,-L*O*Et).addScaledVector(Dt,-R*O),pt?dt.copy(at):dt.lerp(at,1-Math.exp(-st*2.4)),w.lookAt(dt),w.updateMatrixWorld(),b.position.copy(w.position),zt.copy(Pt.quaternion).invert().multiply(w.quaternion),ue.halo.quaternion.copy(zt),ge.halo.quaternion.copy(zt),F.halo.quaternion.copy(zt)}let Le=0,Ge=0;function fi(){let st=t.getBoundingClientRect(),pt=Math.max(1,Math.round(st.width)),Et=Math.max(1,Math.round(st.height));return pt===Le&&Et===Ge?!1:(Le=pt,Ge=Et,w.aspect=Le/Ge,w.updateProjectionMatrix(),c.setPixelRatio(Math.min(window.devicePixelRatio||1,h)),c.setSize(Le,Ge,!1),!0)}fi();let Xn={alt:i.querySelector('[data-hud="alt"]'),spd:i.querySelector('[data-hud="spd"]'),wind:i.querySelector('[data-hud="wind"]')};function gs(){Xn.alt&&(Xn.alt.textContent=String(Math.round(W.alt))),Xn.spd&&(Xn.spd.textContent=W.spd.toFixed(1)),Xn.wind&&(Xn.wind.textContent=W.windSpd.toFixed(1))}let pi=!1;function lr(){pi||(pi=!0,o&&t.classList.add("is-instant"),t.classList.add("is-3d"),n&&(n.hidden=!1),gs())}function _s(st){let pt=.016666666666666666;W.dist=Z*.07,G.getPointAt(.07,W.pos),G.getTangentAt(.07,W.prevVel).multiplyScalar(It(.07)),W.spd=It(.07),W.hook.copy(W.pos);for(let _t=0;_t<Gt;_t++)B[_t].set(W.pos.x,W.pos.y-_t*E,W.pos.z),H[_t].copy(B[_t]);let Et=0;for(;W.dist/Z%1<st&&Et++<4e3;)ae(pt)}if(o){_s(.235),Kt(0,!0),c.render(f,w),lr(),window.addEventListener("resize",()=>{fi()&&(Kt(0,!0),c.render(f,w))},{passive:!0});return}_s(.15),Kt(0,!0);let Dn=0,nn=0,mi=0,gi=0,xs=!1,qn=!0,Ri=!document.hidden;function _i(st){Dn=requestAnimationFrame(_i);let pt=Math.min(.05,nn?(st-nn)/1e3:.016);nn=st,ot.x+=(ot.tx-ot.x)*Math.min(1,pt*3.2),ot.y+=(-ot.ty-ot.y)*Math.min(1,pt*3.2),ae(pt),Kt(pt,!1),c.render(f,w),pi||lr(),mi+=pt,mi>.12&&(mi=0,gs()),xs||(gi=pt>.036?gi+1:Math.max(0,gi-1),gi>45&&(xs=!0,h=1,Le=0,fi()))}let Ii=()=>{!Dn&&qn&&Ri&&(nn=0,Dn=requestAnimationFrame(_i))},vs=()=>{Dn&&(cancelAnimationFrame(Dn),Dn=0)};"IntersectionObserver"in window&&new IntersectionObserver(st=>{qn=st[0].isIntersecting,qn?Ii():vs()},{rootMargin:"140px"}).observe(i),document.addEventListener("visibilitychange",()=>{Ri=!document.hidden,Ri?Ii():vs()}),"ResizeObserver"in window?new ResizeObserver(fi).observe(t):window.addEventListener("resize",fi,{passive:!0}),window.matchMedia("(min-width: 1024px) and (pointer: fine)").matches&&window.addEventListener("pointermove",st=>{let pt=t.getBoundingClientRect();ot.tx=Hn(((st.clientX-pt.left)/pt.width-.5)*2,-1,1),ot.ty=Hn(((st.clientY-pt.top)/pt.height-.5)*2,-1,1)},{passive:!0}),Ii()}var Nh=document.querySelector(".s-data");if(Nh){let i=window.ASO?.isShot,t=window.ASO?.reducedMotion,e=i||t,n=a=>{let o=parseFloat(a.dataset.count),l=a.dataset.decimals?Number(a.dataset.decimals):0;if(!Number.isFinite(o))return;if(e){a.textContent=o.toFixed(l);return}let c=1100,u=performance.now(),p=h=>{let d=Math.min(1,(h-u)/c),x=1-Math.pow(1-d,3);a.textContent=(o*x).toFixed(l),d<1&&requestAnimationFrame(p)};requestAnimationFrame(p)},s=a=>{a.querySelectorAll("[data-bar]").forEach(o=>o.classList.add("is-in")),a.querySelectorAll("[data-count]").forEach(n)},r=Nh.querySelectorAll("[data-chartgroup]");if(e||!("IntersectionObserver"in window))r.forEach(s);else{let a=new IntersectionObserver(o=>{o.forEach(l=>{l.isIntersecting&&(s(l.target),a.unobserve(l.target))})},{rootMargin:"0px 0px -10% 0px",threshold:.3});r.forEach(o=>a.observe(o))}}var Uh=document.querySelector(".s-aircraft");if(Uh){let i=window.ASO?.isShot,t=window.ASO?.reducedMotion,e=i||t,n=o=>Math.round(o).toLocaleString("en-US"),s=o=>{let l=parseFloat(o.dataset.count);if(!Number.isFinite(l))return;if(e){o.textContent=n(l);return}let c=1e3,u=performance.now(),p=h=>{let d=Math.min(1,(h-u)/c),x=1-Math.pow(1-d,3);o.textContent=n(l*x),d<1&&requestAnimationFrame(p)};requestAnimationFrame(p)},r=Uh.querySelector(".s-aircraft__spec-grid"),a=r?[...r.querySelectorAll("[data-count]")]:[];if(a.length)if(e||!("IntersectionObserver"in window))a.forEach(s);else{let o=new IntersectionObserver(l=>{l.forEach(c=>{c.isIntersecting&&(a.forEach(s),o.unobserve(c.target))})},{rootMargin:"0px 0px -10% 0px",threshold:.3});o.observe(r)}}var en=document.querySelector(".s-diagnosis");if(en){let d=function(){return e.map(b=>en.querySelector(`input[name="${b}"]:checked`))},x=function(b){let S=b.filter(Boolean).length;return r.textContent=String(S),s.style.width=`${S/e.length*100}%`,n.setAttribute("aria-valuenow",String(S)),S},M=function(b){let S=b.reduce((v,T)=>v+Number(T.value),0);return b.filter(v=>v.dataset.unknown==="1").length>=3?{tone:"neutral",title:"\u6761\u4EF6\u304C\u5206\u304B\u308C\u3070\u3001\u3082\u3046\u5C11\u3057\u7D5E\u308C\u307E\u3059\u3002",body:"\u5834\u6240\u3068\u8377\u7269\u306E\u304A\u304A\u3088\u305D\u306E\u6761\u4EF6\u304C\u5206\u304B\u308C\u3070\u3001\u30C9\u30ED\u30FC\u30F3\u8F38\u9001\u304C\u5019\u88DC\u306B\u306A\u308B\u304B\u78BA\u8A8D\u3067\u304D\u307E\u3059\u3002"}:S>=5?{tone:"positive",title:"\u30C9\u30ED\u30FC\u30F3\u8F38\u9001\u3092\u691C\u8A0E\u3057\u3084\u3059\u3044\u6761\u4EF6\u3067\u3059\u3002",body:"\u9032\u5165\u6761\u4EF6\u3084\u8377\u7269\u306E\u5206\u5272\u53EF\u5426\u304B\u3089\u3001\u30C9\u30ED\u30FC\u30F3\u3068\u76F8\u6027\u306E\u3088\u3044\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002\u91CD\u91CF\u30FB\u8DDD\u96E2\u30FB\u98DB\u884C\u7D4C\u8DEF\u3092\u78BA\u8A8D\u3057\u3066\u6700\u7D42\u5224\u65AD\u3057\u307E\u3059\u3002"}:S>=2?{tone:"neutral",title:"\u30C9\u30ED\u30FC\u30F3\u8F38\u9001\u306E\u5019\u88DC\u306B\u5165\u308A\u307E\u3059\u3002",body:"\u73FE\u5834\u6761\u4EF6\u306B\u3088\u3063\u3066\u5224\u65AD\u304C\u5206\u304B\u308C\u307E\u3059\u3002\u8377\u7269\u306E\u91CD\u91CF\u30FB\u7DCF\u91CF\u30FB\u8DDD\u96E2\u30FB\u9AD8\u4F4E\u5DEE\u3092\u78BA\u8A8D\u3059\u308B\u3068\u3001\u3088\u308A\u5177\u4F53\u7684\u306B\u5224\u65AD\u3067\u304D\u307E\u3059\u3002"}:{tone:"other",title:"\u30D8\u30EA\u30FB\u8ECA\u4E21\u306A\u3069\u4ED6\u306E\u65B9\u6CD5\u3082\u542B\u3081\u3066\u6BD4\u8F03\u304C\u304A\u3059\u3059\u3081\u3067\u3059\u3002",body:"\u5927\u91CF\u30FB\u5927\u91CD\u91CF\u306E\u4E00\u62EC\u8F38\u9001\u306A\u3069\u306F\u3001\u30C9\u30ED\u30FC\u30F3\u4EE5\u5916\u306E\u65B9\u6CD5\u304C\u5408\u3046\u5834\u5408\u304C\u3042\u308A\u307E\u3059\u3002\u6761\u4EF6\u3092\u78BA\u8A8D\u3057\u3066\u8F38\u9001\u65B9\u6CD5\u3092\u9078\u3073\u307E\u3059\u3002"}},m=function(b,S){return`\u3010\u7C21\u6613\u8A3A\u65AD\u306E\u7D50\u679C\u3011
${b.map(v=>`\u30FB${v.closest("fieldset")?.dataset.qtext??""}\uFF1A${v.dataset.label}`).join(`
`)}
\u5224\u5B9A\uFF1A${S}`},f=function(){if(o.hidden=!1,i||t){o.classList.add("is-in");return}o.classList.remove("is-in"),requestAnimationFrame(()=>requestAnimationFrame(()=>o.classList.add("is-in")))},w=function(){o.className="s-diagnosis__result s-diagnosis__result--neutral",l.textContent="4\u9805\u76EE\u3059\u3079\u3066\u9078\u3093\u3067\u304F\u3060\u3055\u3044\u3002",c.textContent="\u5206\u304B\u3089\u306A\u3044\u9805\u76EE\u306F\u300C\u307E\u3060\u672A\u5B9A\u300D\u300C\u308F\u304B\u3089\u306A\u3044\u300D\u3092\u9078\u3079\u307E\u3059\u3002",u.hidden=!0,h="",f()},I=function(b){let{tone:S,title:C,body:v}=M(b);o.className=`s-diagnosis__result s-diagnosis__result--${S}`,l.textContent=C,c.textContent=v,u.hidden=!1,h=m(b,C),f()},y=function(){o.hidden=!0,o.classList.remove("is-in"),h=""};Pg=d,Lg=x,Dg=M,Ng=m,Ug=f,Fg=w,Og=I,Bg=y;let i=window.ASO?.isShot,t=window.ASO?.reducedMotion,e=["d1","d2","d3","d4"],n=en.querySelector(".s-diagnosis__progress-bar"),s=en.querySelector("[data-progress-fill]"),r=en.querySelector("[data-progress-count]"),a=en.querySelector("[data-diag-button]"),o=en.querySelector("[data-result]"),l=en.querySelector("[data-result-title]"),c=en.querySelector("[data-result-body]"),u=en.querySelector("[data-result-cta]"),p=en.querySelector("[data-diag-cta]"),h="";if(e.forEach(b=>{en.querySelectorAll(`input[name="${b}"]`).forEach(S=>{S.addEventListener("change",()=>{let C=d();x(C),C.every(Boolean)?I(C):o.hidden||y()})})}),a?.addEventListener("click",()=>{let b=d();x(b),b.every(Boolean)?I(b):w()}),p?.addEventListener("click",()=>{h&&window.dispatchEvent(new CustomEvent("aso:prefill",{detail:{message:h}}))}),i){let b={d1:"\u5165\u308C\u306A\u3044",d2:"\u5206\u3051\u3089\u308C\u308B",d3:"\u5927\u304D\u3044",d4:"\u5C0F\u301C\u4E2D\u91CF"};e.forEach(C=>{let v=en.querySelector(`input[name="${C}"][data-label="${b[C]}"]`);v&&(v.checked=!0)});let S=d();x(S),I(S)}}var Pg,Lg,Dg,Ng,Ug,Fg,Og,Bg;var Pn=document.querySelector("[data-player]");if(Pn){let i=Pn.querySelector("[data-video]"),t=Pn.querySelector("[data-play]"),e=navigator.connection?.saveData===!0,n=window.matchMedia("(max-width: 899px)").matches,s=!1,r=()=>{s||(s=!0,Pn.classList.add("is-playing"),i.play().catch(()=>{Pn.classList.remove("is-playing"),s=!1}))};t.addEventListener("click",()=>{if(s){i.pause(),Pn.classList.remove("is-playing"),s=!1;return}r()}),i.addEventListener("click",()=>{s&&(i.pause(),Pn.classList.remove("is-playing"),s=!1)});let a=!n&&!e&&!window.ASO?.reducedMotion&&!window.ASO?.isShot;"IntersectionObserver"in window&&new IntersectionObserver(l=>{l.forEach(c=>{c.isIntersecting?a&&r():s&&(i.pause(),Pn.classList.remove("is-playing"),s=!1)})},{threshold:.45}).observe(Pn),document.addEventListener("visibilitychange",()=>{document.hidden&&s&&(i.pause(),Pn.classList.remove("is-playing"),s=!1)})}var Ln=document.getElementById("contactForm");if(Ln){let i=document.getElementById("contactStatus"),t=document.getElementById("contactDone"),e=document.getElementById("contactMessage"),n=Ln.querySelector("[data-submit]");window.addEventListener("aso:prefill",r=>{let a=r.detail?.message;!a||!e||(e.value=e.value?`${a}
